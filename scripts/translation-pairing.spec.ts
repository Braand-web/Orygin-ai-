...
describe('translation pairing switchers', () => {
  ...
  it('accepts only the canonical public URL for an absolute switcher', () => {
    ...
    const wrongMarkdown = '# README\n\nEnglish | [中文](https://github.com/Braand-web/Orygin-ai-/blob/master/other/README.zh.md)\n'
    ...
    expect(translationStructureSignature(wrongPath, targets, {
      ...
      'https://github.com/Braand-web/Orygin-ai-/blob/master/other/README.zh.md',
    ])
  })
...
describe('translation scope discovery', () => {
  ...
  it.each([
    ...
    'python/sdk-runtime/src/orygin_harness_runtime/runtime/dsh-jsonrpc-agent-macos-arm64/README.md',
    'python/sdk-runtime/src/orygin_harness_runtime/runtime/node/README.md',
