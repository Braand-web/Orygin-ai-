...
function checkManifest(
  ...
  if (owner.packageName === '@orygin-ai/dsh-invariants') return
  if (manifest.peerDependencies?.['@orygin-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@orygin-ai/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@orygin-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@orygin-ai/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@orygin-ai/dsh-invariants'
