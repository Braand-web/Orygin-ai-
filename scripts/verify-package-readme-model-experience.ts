...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/shell-env': { kind: 'indirect', reason: 'The env service exposes managed ORYGIN_* facts through the shell tools (dsh-tool-bash/dsh-tool-pwsh); it registers no prompt or schema of its own.' },
  ...
  'packages/identity/anonymous-user-id': { kind: 'none', reason: 'The shared identifier reaches Orygin only as model-hidden HTTP metadata; it registers nothing model-facing.' },
