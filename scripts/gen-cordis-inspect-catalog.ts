...
import type { CordisCatalogModel, ServiceMethodEntry } from '@orygin-ai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@orygin-ai/dsh-tool-cordis/api-catalog', '@orygin-ai/dsh-cordis-client-runner/client/api-catalog')
