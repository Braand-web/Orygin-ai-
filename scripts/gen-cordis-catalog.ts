...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@orygin-ai/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@orygin-ai/dsh-typert-generator'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  resourceAuthorization: 'credentials.md',
 ...
 * The scan that enforces this list reads EVERY `declare module '@orygin-ai/cordis'`
 ...
 * scan reads EVERY `declare module '@orygin-ai/cordis'` Events merge under
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ProviderUsageReceipt: 'internal commercial accounting payload is owned by packages/billing/billing/README.md',
  BillingRunInput: 'commercial accounting input is owned by packages/billing/billing/README.md',
  BillingPolicy: 'commercial plan policy is owned by packages/billing/billing/README.md',
  RunEstimate: 'commercial accounting result is owned by packages/billing/billing/README.md',
  CreditReservation: 'commercial reservation record is owned by packages/billing/billing/README.md',
  ReservationExtension: 'commercial reservation input is owned by packages/billing/billing/README.md',
  InfrastructureUsageReceipt: 'commercial infrastructure receipt is owned by packages/billing/billing/README.md',
  RunSettlement: 'commercial settlement record is owned by packages/billing/billing/README.md',
  LedgerEntry: 'commercial ledger record is owned by packages/billing/billing/README.md',
  RefundInput: 'commercial refund input is owned by packages/billing/billing/README.md',
  AuthPrincipal: 'verified cloud identity is owned by packages/security/request-context/README.md',
  AuthorizedResourceKind: 'tenant resource vocabulary is owned by packages/security/request-context/README.md',
  ResourceAction: 'tenant resource action vocabulary is owned by packages/security/request-context/README.md',
  PersistenceScope: 'tenant persistence scope is owned by packages/session/session-persistence/README.md',
  ScopedSessionPersistence: 'tenant persistence facade is owned by packages/session/session-persistence/README.md',
