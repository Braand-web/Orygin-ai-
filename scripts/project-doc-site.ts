...
const REPOSITORY_URL = 'https://github.com/Braand-web/Orygin-ai-'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/orygin-ai/orygin-ai/${repositoryRef}/${path}${suffix}`
