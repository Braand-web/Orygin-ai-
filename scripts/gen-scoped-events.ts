...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @orygin-ai/dsh-scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@orygin-ai/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@orygin-ai/cordis'
}
