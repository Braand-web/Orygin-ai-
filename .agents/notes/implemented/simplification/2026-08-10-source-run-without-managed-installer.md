...
That lifecycle is not required to run or develop Orygin from a source checkout. Maintaining it expands the supported filesystem and Git state space without improving the repository-native execution path.
