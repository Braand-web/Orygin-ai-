...
- **Saved/bundled workflows** (a `.orygin/workflows/` registry, slash-command API) and **script persistence to a run directory** (the tool-call event already records the script durably).
