...
Every composition that loads a bash executor also loads `@orygin-ai/dsh-subprocess-local` (CLI, examples, the Python bundled runtime, and inline test configs).
