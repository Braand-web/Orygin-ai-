...
description: Use when reviewing a pull request in the orygin-ai repo — orients the reviewer to this codebase's standards (AGENTS.md conventions, defensive patterns, ADRs, quality gates) and the review-specific checks that code alone can't show
---

# Reviewing a Orygin-Harness PR
