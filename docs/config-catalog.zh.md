...
<a id="orygin-aidsh-acp-demo"></a>

## `@orygin-ai/dsh-acp-demo`
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** Orygin home directory exposed to bash and used for local skill discovery. */
  dshHome?: string
...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#orygin-aidsh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="orygin-aidsh-agent-default-model"></a>

## `@orygin-ai/dsh-agent-default-model`
...
<a id="orygin-aidsh-agent-instructions"></a>

## `@orygin-ai/dsh-agent-instructions`

```ts config-catalog
/** User-facing workspace instruction loader configuration. */
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$ORYGIN_HOME` or `~/.dsh`. */
  dshHome?: string
...
<a id="orygin-aidsh-agent-loop"></a>

## `@orygin-ai/dsh-agent-loop`
...
<a id="orygin-aidsh-agent-presets"></a>

## `@orygin-ai/dsh-agent-presets`
...
<a id="orygin-aidsh-agent-spine-demo"></a>

## `@orygin-ai/dsh-agent-spine-demo`
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** Orygin home directory shared by shell context and local skill discovery. */
  dshHome?: string
...
依赖：[`AgentLoopConfig`](#orygin-aidsh-agent-loop) · [`GoalDomainConfig`](#orygin-aidsh-goal) · [`InvariantConfig`](#orygin-aidsh-invariants) · [`JobsConfig`](#orygin-aidsh-jobs-local) · [`SessionTitleConfig`](#orygin-aidsh-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#orygin-aidsh-skill) · [`SystemPromptConfig`](#orygin-aidsh-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#orygin-aidsh-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="orygin-aidsh-agent-tool-presentation"></a>

## `@orygin-ai/dsh-agent-tool-presentation`
...
<a id="orygin-aidsh-attachment-local"></a>

## `@orygin-ai/dsh-attachment-local`

```ts config-catalog
/** Local attachment backend configuration. */
export interface Config {
  /** Explicit harness home; omitted follows `ORYGIN_HOME`, then `~/.dsh`. */
  dshHome?: string
...
<a id="orygin-aidsh-bash-local"></a>

## `@orygin-ai/dsh-bash-local`
...
<a id="orygin-aidsh-bash-sandbox"></a>

## `@orygin-ai/dsh-bash-sandbox`
 ...
 * on `ctx.sandboxPolicy` (`@orygin-ai/dsh-sandbox-policy`), which resolves
...
依赖：[`LocalConfig`](#orygin-aidsh-bash-local)

来源：[`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)

<a id="orygin-aidsh-client-connection"></a>

## `@orygin-ai/dsh-client-connection`
...
<a id="orygin-aidsh-client-hmr"></a>

## `@orygin-ai/dsh-client-hmr`
...
<a id="orygin-aidsh-code-runtime-worker-thread"></a>

## `@orygin-ai/dsh-code-runtime-worker-thread`
...
<a id="orygin-aidsh-compaction-basic"></a>

## `@orygin-ai/dsh-compaction-basic`
...
<a id="orygin-aidsh-compaction-tool-result-pruner"></a>

## `@orygin-ai/dsh-compaction-tool-result-pruner`
...
<a id="orygin-aidsh-cordis-host-runner"></a>

## `@orygin-ai/dsh-cordis-host-runner`
...
<a id="orygin-aidsh-credentials-local"></a>

## `@orygin-ai/dsh-credentials-local`
...
export interface Config {
  ...
  path?: string
  /** Harness home used when `path` is omitted; defaults to `$ORYGIN_HOME` or `~/.dsh`. */
  dshHome?: string
...
<a id="orygin-aidsh-experimental-agent-team"></a>

## `@orygin-ai/dsh-experimental-agent-team`
...
<a id="orygin-aidsh-experimental-tool-agent-team"></a>

## `@orygin-ai/dsh-experimental-tool-agent-team`
...
<a id="orygin-aidsh-file-reference-local"></a>

## `@orygin-ai/dsh-file-reference-local`
...
<a id="orygin-aidsh-fs-local"></a>

## `@orygin-ai/dsh-fs-local`
...
<a id="orygin-aidsh-fs-sandbox"></a>

## `@orygin-ai/dsh-fs-sandbox`
...
<a id="orygin-aidsh-headless"></a>

## `@orygin-ai/dsh-headless`
...
<a id="orygin-aidsh-hooks-claude-code"></a>

## `@orygin-ai/dsh-hooks-claude-code`
...
<a id="orygin-aidsh-hooks-codex"></a>

## `@orygin-ai/dsh-hooks-codex`
...
<a id="orygin-aidsh-host-apiproxy"></a>

## `@orygin-ai/dsh-host-apiproxy`
...
<a id="orygin-aidsh-host-directory-picker-browse"></a>

## `@orygin-ai/dsh-host-directory-picker-browse`
...
<a id="orygin-aidsh-host-frontend-static"></a>

## `@orygin-ai/dsh-host-frontend-static`
...
<a id="orygin-aidsh-host-webserver"></a>

## `@orygin-ai/dsh-host-webserver`
...
<a id="orygin-aidsh-invariants"></a>

## `@orygin-ai/dsh-invariants`
...
<a id="orygin-aidsh-jobs-local"></a>

## `@orygin-ai/dsh-jobs-local`
...
<a id="orygin-aidsh-llm-orygin"></a>

## `@orygin-ai/dsh-llm-orygin`
 ...
 * as the `llm-orygin` settings-section shape. Every field is optional in
 ...
 */
export interface Config {
  /** Credential reference (environment-variable name) resolved per request; defaults to `ORYGIN_API_KEY`. */
  apiKeyEnv?: string
  /** Endpoint base; falls back to $ORYGIN_BASE_URL from a trusted environment layer, then the public API. */
  baseURL?: string
...
export interface OryginCatalogModel {
  ...
  /** Per-request output cap for this model; omission falls back to the profile's {@link OryginConnectionOptions.maxTokens}. */
  maxTokens?: number
...
来源：[`packages/llm/llm-orygin/src/index.ts:106`](../packages/llm/llm-orygin/src/index.ts)

<a id="orygin-aidsh-llm-pi-ai"></a>

## `@orygin-ai/dsh-llm-pi-ai`
...
<a id="orygin-aidsh-llm-replay"></a>

## `@orygin-ai/dsh-llm-replay`

需要：`llm`

```ts config-catalog
/** Plugin config: the {@link ReplayConfig} inputs, each defaulting to its `ORYGIN_SNAPSHOT_*` env var in `apply`. */
export interface Config {
  /** Override the fixture path; defaults to `$ORYGIN_SNAPSHOT_FILE`. */
  file?: string
  /** Override the sidecar path; defaults to `$ORYGIN_SNAPSHOT_OVERRIDE`. */
  overrideFile?: string
  /**
   * Override the child-log paths; defaults to `$ORYGIN_SNAPSHOT_CHILD_FILES` (a
...
<a id="orygin-aidsh-llm-retry"></a>

## `@orygin-ai/dsh-llm-retry`
...
<a id="orygin-aidsh-lsp-stdio"></a>

## `@orygin-ai/dsh-lsp-stdio`
...
<a id="orygin-aidsh-mcp-client"></a>

## `@orygin-ai/dsh-mcp-client`
...
<a id="orygin-aidsh-message-feedback"></a>

## `@orygin-ai/dsh-message-feedback`
...
<a id="orygin-aidsh-permission-presets"></a>

## `@orygin-ai/dsh-permission-presets`
...
<a id="orygin-aidsh-persona"></a>

## `@orygin-ai/dsh-persona`
...
<a id="orygin-aidsh-plan-mode"></a>

## `@orygin-ai/dsh-plan-mode`
...
<a id="orygin-aidsh-pwsh-local"></a>

## `@orygin-ai/dsh-pwsh-local`
...
<a id="orygin-aidsh-pwsh-sandbox"></a>

## `@orygin-ai/dsh-pwsh-sandbox`
...
依赖：[`LocalConfig`](#orygin-aidsh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="orygin-aidsh-repeat-tool-reminder"></a>

## `@orygin-ai/dsh-repeat-tool-reminder`
...
<a id="orygin-aidsh-sandbox-local"></a>

## `@orygin-ai/dsh-sandbox-local`
...
<a id="orygin-aidsh-sandbox-policy"></a>

## `@orygin-ai/dsh-sandbox-policy`
...
<a id="orygin-aidsh-sdk-jsonrpc-server"></a>

## `@orygin-ai/dsh-sdk-jsonrpc-server`
...
<a id="orygin-aidsh-session-persistence-jsonl"></a>

## `@orygin-ai/dsh-session-persistence-jsonl`
...
<a id="orygin-aidsh-session-persistence-sqlite"></a>

## `@orygin-ai/dsh-session-persistence-sqlite`
...
<a id="orygin-aidsh-session-projection-cache"></a>

## `@orygin-ai/dsh-session-projection-cache`
...
<a id="orygin-aidsh-session-query-sqlite"></a>

## `@orygin-ai/dsh-session-query-sqlite`
...
<a id="orygin-aidsh-session-reference"></a>

## `@orygin-ai/dsh-session-reference`
...
<a id="orygin-aidsh-session-telemetry-otel"></a>

## `@orygin-ai/dsh-session-telemetry-otel`
 ...
 * and one ORYGIN-owned shutdown bound. Uploading modes validate their endpoint
...
<a id="orygin-aidsh-session-title"></a>

## `@orygin-ai/dsh-session-title`
...
<a id="orygin-aidsh-session-title-all-prompts-llm"></a>

## `@orygin-ai/dsh-session-title-all-prompts-llm`
...
<a id="orygin-aidsh-session-title-first-prompt-llm"></a>

## `@orygin-ai/dsh-session-title-first-prompt-llm`
...
<a id="orygin-aidsh-settings-file"></a>

## `@orygin-ai/dsh-settings-file`
...
export interface Config {
  /** Orygin home directory exposed as `ORYGIN_HOME`; defaults to `$ORYGIN_HOME` or `~/.dsh`. */
  dshHome?: string
}
```
...
<a id="orygin-aidsh-skill-filesystem"></a>

## `@orygin-ai/dsh-skill-filesystem`
...
export interface Config {
  ...
  /** Orygin config root. Defaults to `$ORYGIN_HOME` or `~/.dsh`. */
  dshHome?: string
  /** Shared agent config root. Defaults to `$ORYGIN_AGENTS_HOME` or `~/.agents`. */
  agentsHome?: string
  ...
  /** Bundled skill root; defaults to `$ORYGIN_BUNDLED_SKILL_DIR` when default roots are included, otherwise mounts none. */
...
<a id="orygin-aidsh-spill-local"></a>

## `@orygin-ai/dsh-spill-local`
...
<a id="orygin-aidsh-spill-policy"></a>

## `@orygin-ai/dsh-spill-policy`
...
<a id="orygin-aidsh-storage-domain"></a>

## `@orygin-ai/dsh-storage-domain`
...
<a id="orygin-aidsh-storage-json"></a>

## `@orygin-ai/dsh-storage-json`
...
<a id="orygin-aidsh-storage-sqlite"></a>

## `@orygin-ai/dsh-storage-sqlite`
...
<a id="orygin-aidsh-subagent-acp"></a>

## `@orygin-ai/dsh-subagent-acp`
...
export interface Config {
   ...
   * harness's own `ORYGIN_API_KEY`. Forwarded on top of a credential-scrubbed
...
<a id="orygin-aidsh-subagent-claude-code"></a>

## `@orygin-ai/dsh-subagent-claude-code`
...
<a id="orygin-aidsh-subagent-codex"></a>

## `@orygin-ai/dsh-subagent-codex`
...
<a id="orygin-aidsh-subagent-dsh-sdk"></a>

## `@orygin-ai/dsh-subagent-dsh-sdk`
...
export interface Config {
   ...
   */
  cwd?: string
  /** Provider route the child runtime initializes with (default `orygin-official`). */
  provider: string
  /** Model the child runtime initializes with (default `orygin-v4-flash`). */
  model: string
  /** Optional per-request output-token cap for the child runtime. */
  maxTokens?: number
  /**
   * Extra environment variables for the child process — e.g. the child
   * runtime's own `ORYGIN_API_KEY`, or `ORYGIN_CORDIS_CONFIG` naming its
...
<a id="orygin-aidsh-subagent-fork-in-process"></a>

## `@orygin-ai/dsh-subagent-fork-in-process`
...
<a id="orygin-aidsh-subagent-spawn-in-process"></a>

## `@orygin-ai/dsh-subagent-spawn-in-process`
...
<a id="orygin-aidsh-subprocess-e2b"></a>

## `@orygin-ai/dsh-subprocess-e2b`
...
<a id="orygin-aidsh-system-prompt"></a>

## `@orygin-ai/dsh-system-prompt`

```ts config-catalog
/** Plugin config: the deployment-authored fragment of the system prompt (see {@link Config.persona} for its contract). */
export interface Config {
  /** Include the fixed Orygin identity before the deployment persona (default true). */
...
<a id="orygin-aidsh-terminal-bash"></a>

## `@orygin-ai/dsh-terminal-bash`
...
<a id="orygin-aidsh-time-context"></a>

## `@orygin-ai/dsh-time-context`
...
<a id="orygin-aidsh-tmux-context"></a>

## `@orygin-ai/dsh-tmux-context`
...
<a id="orygin-aidsh-token-meter"></a>

## `@orygin-ai/dsh-token-meter`
...
<a id="orygin-aidsh-tool-bash"></a>

## `@orygin-ai/dsh-tool-bash`
...
<a id="orygin-aidsh-tool-bash-persistent"></a>

## `@orygin-ai/dsh-tool-bash-persistent`
...
<a id="orygin-aidsh-tool-fs"></a>

## `@orygin-ai/dsh-tool-fs`
...
<a id="orygin-aidsh-tool-fs-search"></a>

## `@orygin-ai/dsh-tool-fs-search`
...
export interface Config {
   ...
   * `@orygin-ai/dsh-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
```
...
<a id="orygin-aidsh-tool-goal"></a>

## `@orygin-ai/dsh-tool-goal`
...
<a id="orygin-aidsh-tool-jobs"></a>

## `@orygin-ai/dsh-tool-jobs`
...
<a id="orygin-aidsh-tool-lsp"></a>

## `@orygin-ai/dsh-tool-lsp`
...
<a id="orygin-aidsh-tool-pwsh"></a>

## `@orygin-ai/dsh-tool-pwsh`
...
<a id="orygin-aidsh-tool-pwsh-persistent"></a>

## `@orygin-ai/dsh-tool-pwsh-persistent`
...
<a id="orygin-aidsh-tool-ralph"></a>

## `@orygin-ai/dsh-tool-ralph`
...
<a id="orygin-aidsh-tool-session-query"></a>

## `@orygin-ai/dsh-tool-session-query`
...
<a id="orygin-aidsh-tool-skill"></a>

## `@orygin-ai/dsh-tool-skill`
...
<a id="orygin-aidsh-tool-str-replace-editor"></a>

## `@orygin-ai/dsh-tool-str-replace-editor`
...
<a id="orygin-aidsh-tool-subagent"></a>

## `@orygin-ai/dsh-tool-subagent`
...
<a id="orygin-aidsh-tool-subagent-report"></a>

## `@orygin-ai/dsh-tool-subagent-report`
...
<a id="orygin-aidsh-tool-terminal"></a>

## `@orygin-ai/dsh-tool-terminal`
...
<a id="orygin-aidsh-tool-todo"></a>

## `@orygin-ai/dsh-tool-todo`
...
<a id="orygin-aidsh-tool-web"></a>

## `@orygin-ai/dsh-tool-web`
...
<a id="orygin-aidsh-tool-workflow"></a>

## `@orygin-ai/dsh-tool-workflow`
...
<a id="orygin-aidsh-typert-loader"></a>

## `@orygin-ai/dsh-typert-loader`
...
<a id="orygin-aidsh-user-approval"></a>

## `@orygin-ai/dsh-user-approval`
...
<a id="orygin-aidsh-web-app"></a>

## `@orygin-ai/dsh-web-app`
...
export interface Config {
   ...
   * section and the `ORYGIN_WEB_URL` bash variable). A one-shot non-interactive
...
<a id="orygin-aidsh-web-fetch-http"></a>

## `@orygin-ai/dsh-web-fetch-http`
...
<a id="orygin-aidsh-web-search-orygin"></a>

## `@orygin-ai/dsh-web-search-orygin`
...
来源：[`packages/web/web-search-orygin/src/index.ts:46`](../packages/web/web-search-orygin/src/index.ts)

<a id="orygin-aidsh-web-search-exa"></a>

## `@orygin-ai/dsh-web-search-exa`
...
<a id="orygin-aidsh-web-search-perplexity"></a>

## `@orygin-ai/dsh-web-search-perplexity`
...
<a id="orygin-aidsh-workflow-worker-thread"></a>

## `@orygin-ai/dsh-workflow-worker-thread`
...
- `@orygin-ai/dsh-agent`（[`packages/core/agent/src/index.ts`](../packages/core/agent/src/index.ts)）
- `@orygin-ai/dsh-api-gateway` — 需要 `typert`（[`packages/api/gateway/src/index.ts`](../packages/api/gateway/src/index.ts)）
- `@orygin-ai/dsh-api-remotes`（[`packages/api/remotes/src/index.ts`](../packages/api/remotes/src/index.ts)）
- `@orygin-ai/dsh-authorization` — 需要 `credentials`（[`packages/credentials/authorization/src/index.ts`](../packages/credentials/authorization/src/index.ts)）
- `@orygin-ai/dsh-client-locale`（[`packages/client/locale/src/index.ts`](../packages/client/locale/src/index.ts)）
- `@orygin-ai/dsh-client-modules` — 需要 `webServer` · `loader`（[`packages/client/modules/src/index.ts`](../packages/client/modules/src/index.ts)）
- `@orygin-ai/dsh-client-runtime`（[`packages/client/runtime/src/index.ts`](../packages/client/runtime/src/index.ts)）
- `@orygin-ai/dsh-client-ui-agent-preset`（[`packages/client/ui-agent-preset/src/index.ts`](../packages/client/ui-agent-preset/src/index.ts)）
- `@orygin-ai/dsh-client-ui-attachment`（[`packages/client/ui-attachment/src/index.ts`](../packages/client/ui-attachment/src/index.ts)）
- `@orygin-ai/dsh-client-ui-brand-official`（[`packages/client/ui-brand-official/src/index.ts`](../packages/client/ui-brand-official/src/index.ts)）
- `@orygin-ai/dsh-client-ui-commands`（[`packages/client/ui-commands/src/index.ts`](../packages/client/ui-commands/src/index.ts)）
- `@orygin-ai/dsh-client-ui-conversation`（[`packages/client/ui-conversation/src/index.ts`](../packages/client/ui-conversation/src/index.ts)）
- `@orygin-ai/dsh-client-ui-cordis`（[`packages/extensions/ui-cordis/src/index.ts`](../packages/extensions/ui-cordis/src/index.ts)）
- `@orygin-ai/dsh-client-ui-deliverables` — 需要 `systemPrompt`（[`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts)）
- `@orygin-ai/dsh-client-ui-directory-picker-browse`（[`packages/client/ui-directory-picker-browse/src/index.ts`](../packages/client/ui-directory-picker-browse/src/index.ts)）
- `@orygin-ai/dsh-client-ui-directory-picker-native`（[`packages/client/ui-directory-picker-native/src/index.ts`](../packages/client/ui-directory-picker-native/src/index.ts)）
- `@orygin-ai/dsh-client-ui-goal`（[`packages/client/ui-goal/src/index.ts`](../packages/client/ui-goal/src/index.ts)）
- `@orygin-ai/dsh-client-ui-input-trigger`（[`packages/client/ui-input-trigger/src/index.ts`](../packages/client/ui-input-trigger/src/index.ts)）
- `@orygin-ai/dsh-client-ui-jobs`（[`packages/client/ui-jobs/src/index.ts`](../packages/client/ui-jobs/src/index.ts)）
- `@orygin-ai/dsh-client-ui-layout`（[`packages/client/ui-layout/src/index.ts`](../packages/client/ui-layout/src/index.ts)）
- `@orygin-ai/dsh-client-ui-message-feedback`（[`packages/client/ui-message-feedback/src/index.ts`](../packages/client/ui-message-feedback/src/index.ts)）
- `@orygin-ai/dsh-client-ui-model-selection`（[`packages/client/ui-model-selection/src/index.ts`](../packages/client/ui-model-selection/src/index.ts)）
- `@orygin-ai/dsh-client-ui-permission-presets`（[`packages/client/ui-permission-presets/src/index.ts`](../packages/client/ui-permission-presets/src/index.ts)）
- `@orygin-ai/dsh-client-ui-plan`（[`packages/client/ui-plan/src/index.ts`](../packages/client/ui-plan/src/index.ts)）
- `@orygin-ai/dsh-client-ui-reference`（[`packages/client/ui-reference/src/index.ts`](../packages/client/ui-reference/src/index.ts)）
- `@orygin-ai/dsh-client-ui-renderer`（[`packages/client/ui-renderer/src/index.ts`](../packages/client/ui-renderer/src/index.ts)）
- `@orygin-ai/dsh-client-ui-settings`（[`packages/client/ui-settings/src/index.ts`](../packages/client/ui-settings/src/index.ts)）
- `@orygin-ai/dsh-client-ui-settings-general`（[`packages/client/ui-settings-general/src/index.ts`](../packages/client/ui-settings-general/src/index.ts)）
- `@orygin-ai/dsh-client-ui-settings-models`（[`packages/client/ui-settings-models/src/index.ts`](../packages/client/ui-settings-models/src/index.ts)）
- `@orygin-ai/dsh-client-ui-settings-plugin-inventory`（[`packages/client/ui-settings-plugin-inventory/src/index.ts`](../packages/client/ui-settings-plugin-inventory/src/index.ts)）
- `@orygin-ai/dsh-client-ui-settings-plugins`（[`packages/client/ui-settings-plugins/src/index.ts`](../packages/client/ui-settings-plugins/src/index.ts)）
- `@orygin-ai/dsh-client-ui-sidebar`（[`packages/client/ui-sidebar/src/index.ts`](../packages/client/ui-sidebar/src/index.ts)）
- `@orygin-ai/dsh-client-ui-skill`（[`packages/client/ui-skill/src/index.ts`](../packages/client/ui-skill/src/index.ts)）
- `@orygin-ai/dsh-client-ui-subagent`（[`packages/client/ui-subagent/src/index.ts`](../packages/client/ui-subagent/src/index.ts)）
- `@orygin-ai/dsh-client-ui-theme`（[`packages/client/ui-theme/src/index.ts`](../packages/client/ui-theme/src/index.ts)）
- `@orygin-ai/dsh-client-ui-tool`（[`packages/client/ui-tool/src/index.ts`](../packages/client/ui-tool/src/index.ts)）
- `@orygin-ai/dsh-client-ui-trajectory`（[`packages/client/ui-trajectory/src/index.ts`](../packages/client/ui-trajectory/src/index.ts)）
- `@orygin-ai/dsh-client-ui-user-questions`（[`packages/client/ui-user-questions/src/index.ts`](../packages/client/ui-user-questions/src/index.ts)）
- `@orygin-ai/dsh-client-ui-workflow-run`（[`packages/client/ui-workflow-run/src/index.ts`](../packages/client/ui-workflow-run/src/index.ts)）
- `@orygin-ai/dsh-client-ui-workspace`（[`packages/client/ui-workspace/src/index.ts`](../packages/client/ui-workspace/src/index.ts)）
- `@orygin-ai/dsh-command-compact` — 需要 `commands` · `compact`（[`packages/compaction/command-compact/src/index.ts`](../packages/compaction/command-compact/src/index.ts)）
- `@orygin-ai/dsh-command-feedback` — 需要 `commands`（[`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts)）
- `@orygin-ai/dsh-command-goal` — 需要 `commands` · `goals`（[`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts)）
- `@orygin-ai/dsh-commands`（[`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts)）
- `@orygin-ai/dsh-cordis-client-runner`（[`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts)）
- `@orygin-ai/dsh-fs-e2b` — 需要 `e2b`（[`packages/e2b/fs-e2b/src/index.ts`](../packages/e2b/fs-e2b/src/index.ts)）
- `@orygin-ai/dsh-fs-observation-policy`（[`packages/fs/fs-observation-policy/src/index.ts`](../packages/fs/fs-observation-policy/src/index.ts)）
- `@orygin-ai/dsh-goal-round-driver` — 需要 `agents` · `goals` · `sessions`（[`packages/goal/goal-round-driver/src/index.ts`](../packages/goal/goal-round-driver/src/index.ts)）
- `@orygin-ai/dsh-host-directory-picker-auto` — 需要 `webServer` · `loader`（[`packages/host/directory-picker-auto/src/index.ts`](../packages/host/directory-picker-auto/src/index.ts)）
- `@orygin-ai/dsh-host-directory-picker-native`（[`packages/host/directory-picker-native/src/index.ts`](../packages/host/directory-picker-native/src/index.ts)）
- `@orygin-ai/dsh-host-plugin-inventory` — 需要 `loader`（[`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts)）
- `@orygin-ai/dsh-llm`（[`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts)）
- `@orygin-ai/dsh-lsp`（[`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts)）
- `@orygin-ai/dsh-schedule` — 需要 `agents` · `sessions` · `tools` · `sessionPersistence`（[`packages/schedule/schedule/src/index.ts`](../packages/schedule/schedule/src/index.ts)）
- `@orygin-ai/dsh-session`（[`packages/core/session/src/index.ts`](../packages/core/session/src/index.ts)）
- `@orygin-ai/dsh-session-checkpoint-policy` — 需要 `llm` · `sessionPersistence` · `sessions` · `tools`（[`packages/session/session-checkpoint-policy/src/index.ts`](../packages/session/session-checkpoint-policy/src/index.ts)）
- `@orygin-ai/dsh-session-log-export` — 需要 `commands`（[`packages/session-query/session-log-export/src/index.ts`](../packages/session-query/session-log-export/src/index.ts)）
- `@orygin-ai/dsh-session-projection`（[`packages/session/session-projection/src/index.ts`](../packages/session/session-projection/src/index.ts)）
- `@orygin-ai/dsh-session-stats` — 需要 `sessionProjections`（[`packages/session/session-stats/src/index.ts`](../packages/session/session-stats/src/index.ts)）
- `@orygin-ai/dsh-skill-badge` — 需要 `skills`（[`packages/skill/skill-badge/src/index.ts`](../packages/skill/skill-badge/src/index.ts)）
- `@orygin-ai/dsh-storage`（[`packages/storage/storage/src/index.ts`](../packages/storage/storage/src/index.ts)）
- `@orygin-ai/dsh-subagent`（[`packages/subagent/subagent/src/index.ts`](../packages/subagent/subagent/src/index.ts)）
- `@orygin-ai/dsh-subprocess-local`（[`packages/subprocess/subprocess-local/src/index.ts`](../packages/subprocess/subprocess-local/src/index.ts)）
- `@orygin-ai/dsh-terminal`（[`packages/terminal/terminal/src/index.ts`](../packages/terminal/terminal/src/index.ts)）
- `@orygin-ai/dsh-tool-ask-user` — 需要 `tools` · `userInteraction`（[`packages/interaction/tool-ask-user/src/index.ts`](../packages/interaction/tool-ask-user/src/index.ts)）
- `@orygin-ai/dsh-tool-call-timeout-policy` — 需要 `tools`（[`packages/guard/timeout-policy/src/index.ts`](../packages/guard/timeout-policy/src/index.ts)）
- `@orygin-ai/dsh-tool-cordis` — 需要 `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect`（[`packages/extensions/tool-cordis/src/index.ts`](../packages/extensions/tool-cordis/src/index.ts)）
- `@orygin-ai/dsh-tool-subagent-control` — 需要 `tools` · `subagents`（[`packages/subagent/tool-subagent-control/src/index.ts`](../packages/subagent/tool-subagent-control/src/index.ts)）
- `@orygin-ai/dsh-user-questions`（[`packages/interaction/user-questions/src/index.ts`](../packages/interaction/user-questions/src/index.ts)）
- `@orygin-ai/dsh-workspace` — 需要 `storageDomain` · `sessionPersistence`（[`packages/workspace/workspace/src/index.ts`](../packages/workspace/workspace/src/index.ts)）

## Seam 包（不可直接加载）

抽象服务类——部署时应改为加载具体的实现包（参见[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。

- `@orygin-ai/dsh-attachment` — 抽象 `AttachmentStore`（[`packages/attachment/attachment/src/index.ts`](../packages/attachment/attachment/src/index.ts)）
- `@orygin-ai/dsh-code-runtime` — 抽象 `CodeRuntime`（[`packages/code-runtime/code-runtime/src/index.ts`](../packages/code-runtime/code-runtime/src/index.ts)）
- `@orygin-ai/dsh-compaction` — 抽象 `CompactionEngine`（[`packages/compaction/compaction/src/index.ts`](../packages/compaction/compaction/src/index.ts)）
- `@orygin-ai/dsh-credentials` — 抽象 `Credentials`（[`packages/credentials/credentials/src/index.ts`](../packages/credentials/credentials/src/index.ts)）
- `@orygin-ai/dsh-file-reference` — 抽象 `FileReferenceService`（[`packages/context/file-reference/src/index.ts`](../packages/context/file-reference/src/index.ts)）
- `@orygin-ai/dsh-fs` — 抽象 `FileSystem`（[`packages/fs/fs/src/index.ts`](../packages/fs/fs/src/index.ts)）
- `@orygin-ai/dsh-host-directory-picker` — 抽象 `DirectoryPicker`（[`packages/host/directory-picker/src/index.ts`](../packages/host/directory-picker/src/index.ts)）
- `@orygin-ai/dsh-jobs` — 抽象 `JobRegistry`（[`packages/jobs/jobs/src/index.ts`](../packages/jobs/jobs/src/index.ts)）
- `@orygin-ai/dsh-sandbox` — 抽象 `SandboxProvider`（[`packages/sandbox/sandbox/src/index.ts`](../packages/sandbox/sandbox/src/index.ts)）
- `@orygin-ai/dsh-session-persistence` — 抽象 `SessionPersistence`（[`packages/session/session-persistence/src/index.ts`](../packages/session/session-persistence/src/index.ts)）
- `@orygin-ai/dsh-session-query` — 抽象 `SessionQueryEngine`（[`packages/session-query/session-query/src/index.ts`](../packages/session-query/session-query/src/index.ts)）
- `@orygin-ai/dsh-settings` — 抽象 `Settings`（[`packages/settings/settings/src/index.ts`](../packages/settings/settings/src/index.ts)）
- `@orygin-ai/dsh-shell` — 抽象 `ShellExecutor`（[`packages/shell/shell/src/index.ts`](../packages/shell/shell/src/index.ts)）
- `@orygin-ai/dsh-spill` — 抽象 `SpillStore`（[`packages/spill/spill/src/index.ts`](../packages/spill/spill/src/index.ts)）
- `@orygin-ai/dsh-subprocess` — 抽象 `SubprocessRuntime`（[`packages/subprocess/subprocess/src/index.ts`](../packages/subprocess/subprocess/src/index.ts)）
- `@orygin-ai/dsh-workflow` — 抽象 `WorkflowEngine`（[`packages/workflow/workflow/src/index.ts`](../packages/workflow/workflow/src/index.ts)）
## 库包（无插件入口）

由其他包作为库导入；`cordis.yml` 无法加载它们。

- `@orygin-ai/dsh-acp-snapshot`（[`packages/test-support/acp-snapshot/src/index.ts`](../packages/test-support/acp-snapshot/src/index.ts)）
- `@orygin-ai/dsh-agent-loop-testkit`（[`packages/test-support/agent-loop-testkit/src/index.ts`](../packages/test-support/agent-loop-testkit/src/index.ts)）
- `@orygin-ai/dsh-anonymous-user-id`（[`packages/identity/anonymous-user-id/src/index.ts`](../packages/identity/anonymous-user-id/src/index.ts)）
- `@orygin-ai/dsh-app-boot`（[`packages/boot/app-boot/src/index.ts`](../packages/boot/app-boot/src/index.ts)）
- `@orygin-ai/dsh-atomic-write`（[`packages/util/atomic-write/src/index.ts`](../packages/util/atomic-write/src/index.ts)）
- `@orygin-ai/dsh-base`（[`packages/bundle/base/src/index.ts`](../packages/bundle/base/src/index.ts)）
- `@orygin-ai/dsh-brand`（[`packages/util/brand/src/index.ts`](../packages/util/brand/src/index.ts)）
- `@orygin-ai/dsh-client-test-runtime`（[`packages/test-support/client-runtime/src/index.ts`](../packages/test-support/client-runtime/src/index.ts)）
- `@orygin-ai/dsh-client-ui-primitives`（[`packages/client/ui-primitives/src/index.ts`](../packages/client/ui-primitives/src/index.ts)）
- `@orygin-ai/dsh-client-ui-slots`（[`packages/client/ui-slots/src/index.ts`](../packages/client/ui-slots/src/index.ts)）
- `@orygin-ai/dsh-client-web`（[`packages/client/web/src/index.ts`](../packages/client/web/src/index.ts)）
- `@orygin-ai/dsh-cmdline`（[`packages/boot/cmdline/src/index.ts`](../packages/boot/cmdline/src/index.ts)）
- `@orygin-ai/dsh-code-runtime-python`（[`packages/code-runtime/code-runtime-python/src/index.ts`](../packages/code-runtime/code-runtime-python/src/index.ts)）
- `@orygin-ai/dsh-home-paths`（[`packages/util/home-paths/src/index.ts`](../packages/util/home-paths/src/index.ts)）
- `@orygin-ai/dsh-hook-protocol`（[`packages/hooks/hook-protocol/src/index.ts`](../packages/hooks/hook-protocol/src/index.ts)）
- `@orygin-ai/dsh-launch-environment`（[`packages/util/launch-environment/src/index.ts`](../packages/util/launch-environment/src/index.ts)）
- `@orygin-ai/dsh-llm-mock-server`（[`packages/test-support/llm-mock-server/src/index.ts`](../packages/test-support/llm-mock-server/src/index.ts)）
- `@orygin-ai/dsh-loader-smoke`（[`packages/test-support/loader-smoke/src/index.ts`](../packages/test-support/loader-smoke/src/index.ts)）
- `@orygin-ai/dsh-native-command`（[`packages/util/native-command/src/index.ts`](../packages/util/native-command/src/index.ts)）
- `@orygin-ai/dsh-output-retention`（[`packages/util/output-retention/src/index.ts`](../packages/util/output-retention/src/index.ts)）
- `@orygin-ai/dsh-sandbox-windows-acl`（[`packages/sandbox/sandbox-windows-acl/src/index.ts`](../packages/sandbox/sandbox-windows-acl/src/index.ts)）
- `@orygin-ai/dsh-scope`（[`packages/core/scope/src/index.ts`](../packages/core/scope/src/index.ts)）
- `@orygin-ai/dsh-sdk-client`（[`packages/sdk/client/src/index.ts`](../packages/sdk/client/src/index.ts)）
- `@orygin-ai/dsh-sdk-jsonrpc-demo`（[`packages/examples/jsonrpc-demo/src/index.ts`](../packages/examples/jsonrpc-demo/src/index.ts)）
- `@orygin-ai/dsh-sdk-protocol`（[`packages/sdk/protocol/src/index.ts`](../packages/sdk/protocol/src/index.ts)）
- `@orygin-ai/dsh-session-telemetry`（[`packages/session/session-telemetry/src/index.ts`](../packages/session/session-telemetry/src/index.ts)）
- `@orygin-ai/dsh-session-title-llm`（[`packages/session/session-title-llm/src/index.ts`](../packages/session/session-title-llm/src/index.ts)）
- `@orygin-ai/dsh-subagent-in-process-driver`（[`packages/subagent/subagent-in-process-driver/src/index.ts`](../packages/subagent/subagent-in-process-driver/src/index.ts)）
- `@orygin-ai/dsh-timeout`（[`packages/util/timeout/src/index.ts`](../packages/util/timeout/src/index.ts)）
- `@orygin-ai/dsh-typert-generator`（[`packages/typert/generator/src/index.ts`](../packages/typert/generator/src/index.ts)）
- `@orygin-ai/dsh-typert-protocol`（[`packages/typert/protocol/src/index.ts`](../packages/typert/protocol/src/index.ts)）
- `@orygin-ai/dsh-typert-registry`（[`packages/typert/registry/src/index.ts`](../packages/typert/registry/src/index.ts)）
