...
Open **Settings → Models**, enter a [Orygin API key](https://platform.orygin.fun/), and save it. The model route becomes usable immediately without restarting the server.
