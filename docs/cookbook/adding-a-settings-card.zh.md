...
import type {} from '@orygin-ai/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@orygin-ai/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@orygin-ai/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
