...
| [billing.md](billing.md) | server-only commercial accounting, reservations, receipts, and settlement |
...
| [subprocess.md](subprocess.md) | the subprocess seam: fully-explicit `SubprocessSpawnSpec`, offset-based output readers, unclassified `SubprocessOutcome`, and the managed `ORYGIN_*` environment vocabulary |
