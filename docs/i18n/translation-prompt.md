...
- Source code block contains: `# full-screen TUI coding agent (needs ORYGIN_API_KEY)`
- Bad: `# 全屏 TUI coding agent（需要 ORYGIN_API_KEY）`
- Good: `# full-screen TUI coding agent (needs ORYGIN_API_KEY)` (keep exactly as-is, byte-for-byte)
