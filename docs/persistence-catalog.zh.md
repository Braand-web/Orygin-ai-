...
<a id="weborygin-search-llm-request--log-only"></a>

#### `web/orygin-search-llm-request` — log-only
...
来源：[`packages/web/web-search-orygin/src/provider.ts:83`](../packages/web/web-search-orygin/src/provider.ts)
