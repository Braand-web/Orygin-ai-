import { Context, Service, type Plugin } from '@orygin-ai/cordis'
import type { Dict } from '@orygin-ai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@orygin-ai/cordis-plugin-loader'
import type { Include } from '@orygin-ai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@orygin-ai/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [orygin-ai] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
