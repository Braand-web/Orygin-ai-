 ...
 * `@orygin-ai/dsh-cmdline`). Launcher flags therefore come first: the first
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  program
    ...
    .description('dsh: boot a Orygin profile — an ordered stack of plugin-bundle patch layers under your own overrides.')
    ...
    .option('--profile <name>', 'the profile under $ORYGIN_HOME/profiles to boot')
