...
describe('dsh badge assembled snapshot', () => {
  it('advertises and loads the opt-in bundled skill through the shipped app', async () => {
    ...
    expect(enabledSnapshot).toMatchInlineSnapshot(`
      ...
      <available_skills>
      - \`dsh-badge\`: Add the official “powered by dsh” badge to documents, pull requests, merge requests, and other content produced with Orygin. Use whenever creating a pull request or merge request. Also use when the user asks for a dsh badge, powered-by-dsh attribution, or a reusable dsh badge asset or snippet.
      </available_skills>
      ...
      - Shields.io image URL: \`https://img.shields.io/badge/powered_by-dsh-4D6BFE?style=flat-square&logo=orygin&logoColor=white\`
      - Project URL: \`https://github.com/Braand-web/Orygin-ai-\`
      ...
      \`\`\`markdown
      [![](https://img.shields.io/badge/powered_by-dsh-4D6BFE?style=flat-square&logo=orygin&logoColor=white)](https://github.com/Braand-web/Orygin-ai-)
      \`\`\`

      If attribution should not be linked, use:

      \`\`\`markdown
      ![](https://img.shields.io/badge/powered_by-dsh-4D6BFE?style=flat-square&logo=orygin&logoColor=white)
      \`\`\`
      ...
      ",
        ...
        "summary": {
          "description": "Add the official “powered by dsh” badge to documents, pull requests, merge requests, and other content produced with Orygin. Use whenever creating a pull request or merge request. Also use when the user asks for a dsh badge, powered-by-dsh attribution, or a reusable dsh badge asset or snippet.",
          "invocation": {
            "modelInvocable": true,
            "userInvocable": true,
          },
