...
import type {} from '@orygin-ai/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@orygin-ai/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@orygin-ai/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@orygin-ai/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@orygin-ai/dsh-skill-filesystem"}\n',
