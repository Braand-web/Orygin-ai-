...
// orygin-ai#1406): "increase an 800×720 browser regression test and
...
import type {} from '@orygin-ai/dsh-plan-mode'
...
describe('web e2e: plan chip click area at the narrow viewport', () => {
  ...
  it('keeps the plan chip and model trigger disjoint and exits plan mode by click', async () => {
    ...
    await expect.poll(() => trigger.getAttribute('aria-label'), { timeout: 10_000 }).toContain('Orygin-V4-Flash')
