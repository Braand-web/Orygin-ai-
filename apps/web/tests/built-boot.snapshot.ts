...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  expect(screen.queryByText('ORYGIN Local Build')).toBeNull()
  ...
  for (const plugin of ['@orygin-ai/dsh-client-ui-layout', '@orygin-ai/dsh-client-ui-sidebar', '@orygin-ai/dsh-client-ui-conversation', '@orygin-ai/dsh-client-ui-tool']) {
