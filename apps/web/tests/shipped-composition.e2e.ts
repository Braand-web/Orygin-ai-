...
import { canonicalPath, writableRoots } from '@orygin-ai/dsh-sandbox'
...
import type {} from '@orygin-ai/dsh-sandbox-policy'
import type {} from '@orygin-ai/dsh-user-approval'
import type {} from '@orygin-ai/dsh-permission-presets'
...
it('assembles the shipped Web catalog, file-reference guidance, retry policy, and confined access default', async () => {
  ...
  expect(ctx.llm.providerRetryPolicy('orygin-official')).toMatchInlineSnapshot(`
    {
      "initialDelayMs": 500,
      "jitterRatio": 0.1,
      "maxDelayMs": 10000,
  ...
  `)
  await ctx.settings.update(settingsNamespace('llm-orygin'), {
