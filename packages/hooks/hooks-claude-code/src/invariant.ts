/**
 * Package-owned invariant companion for `@orygin-ai/dsh-hooks-claude-code`.
 * @module @orygin-ai/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-hooks-claude-code'
