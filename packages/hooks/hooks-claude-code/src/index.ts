 ...
 * @module @orygin-ai/dsh-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@orygin-ai/dsh-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@orygin-ai/dsh-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@orygin-ai/dsh-subagent'
