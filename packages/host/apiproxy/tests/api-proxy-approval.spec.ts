...
import type { ApprovalRequestId } from '@orygin-ai/dsh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@orygin-ai/dsh-host-apiproxy/api'
import type { RpcId } from '@orygin-ai/dsh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@orygin-ai/dsh-host-apiproxy/api/rpc'
