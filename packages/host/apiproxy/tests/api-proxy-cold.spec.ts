...
import { TypertLookupFailure } from '@orygin-ai/dsh-typert-protocol'
import TypertRegistry from '@orygin-ai/dsh-typert-registry'
import { createUserMessage, MessageId } from '@orygin-ai/dsh-llm'
import type { Agent } from '@orygin-ai/dsh-agent'
import UserQuestionService from '@orygin-ai/dsh-user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@orygin-ai/dsh-session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@orygin-ai/dsh-session-persistence'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@orygin-ai/dsh-session').Session
