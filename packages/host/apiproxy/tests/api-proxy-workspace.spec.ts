...
import type { Agent, AgentFactory } from '@orygin-ai/dsh-agent'
...
import type { DirectoryPickerCapability } from '@orygin-ai/dsh-host-directory-picker'
import WorkspaceRegistry from '@orygin-ai/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@orygin-ai/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@orygin-ai/dsh-host-apiproxy/api/rpc'
