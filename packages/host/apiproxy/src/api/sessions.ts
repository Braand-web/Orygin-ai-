...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@orygin-ai/dsh-attachment'
import type { ContentBlock } from '@orygin-ai/dsh-llm/types'
import type { SessionEvent, SessionId } from '@orygin-ai/dsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@orygin-ai/dsh-session-projection/types'
...
declare module '@orygin-ai/dsh-llm' {
