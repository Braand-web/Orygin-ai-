...
import type { AskUserQuestionItem } from '@orygin-ai/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@orygin-ai/dsh-user-approval/types'
import type { Message } from '@orygin-ai/dsh-llm/types'
import type { MessageId } from '@orygin-ai/dsh-llm/brand'
import type { CallId } from '@orygin-ai/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@orygin-ai/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@orygin-ai/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@orygin-ai/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
