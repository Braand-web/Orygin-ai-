/**
 * Package-owned invariant companion for `@orygin-ai/dsh-host-apiproxy`.
 * @module @orygin-ai/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-host-apiproxy'
