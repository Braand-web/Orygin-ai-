/**
 * Package-owned invariant companion for `@orygin-ai/dsh-host-frontend-static`.
 * @module @orygin-ai/dsh-host-frontend-static/invariant
 */

import type { Context } from '@orygin-ai/cordis'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-host-frontend-static'
