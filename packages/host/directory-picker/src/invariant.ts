/** Package-owned invariant companion for the directory-picker seam. @module @orygin-ai/dsh-host-directory-picker/invariant */

import type { Context } from '@orygin-ai/cordis'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-host-directory-picker'
