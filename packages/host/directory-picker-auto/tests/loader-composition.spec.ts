...
import HttpServer from '@orygin-ai/dsh-host-webserver'
import type { DirectoryPicker } from '@orygin-ai/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@orygin-ai/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@orygin-ai/dsh-host-directory-picker-native'
...
const AUTO = '@orygin-ai/dsh-host-directory-picker-auto'
const NATIVE = '@orygin-ai/dsh-host-directory-picker-native'
const BROWSE = '@orygin-ai/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@orygin-ai/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@orygin-ai/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@orygin-ai/dsh-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@orygin-ai/dsh-host-webserver', HttpServer],
