 ...
 * @module @orygin-ai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@orygin-ai/dsh-host-directory-picker-native',
  browse: '@orygin-ai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@orygin-ai/dsh-client-ui-directory-picker-native',
  browse: '@orygin-ai/dsh-client-ui-directory-picker-browse',
}
