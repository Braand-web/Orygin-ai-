/**
 * Package-owned invariant companion for `@orygin-ai/dsh-host-webserver`.
 * @module @orygin-ai/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-host-webserver'
