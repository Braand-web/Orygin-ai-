 ...
 * `@orygin-ai/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @orygin-ai/dsh-web-fetch-http/provider
 */

import { WebError } from '@orygin-ai/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@orygin-ai/dsh-web'
