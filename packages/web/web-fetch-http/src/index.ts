/**
 * `@orygin-ai/dsh-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @orygin-ai/dsh-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'orygin-ai/0.0.1 (+https://github.com/Braand-web)'
