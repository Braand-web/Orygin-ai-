/**
 * Provider-private wire types for Orygin's Anthropic-compatible Messages API. Citeable
 ...
 * @module @orygin-ai/dsh-web-search-orygin/types
 */
...
/** Orygin's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** Orygin's error response envelope (best-effort; fields vary). */
