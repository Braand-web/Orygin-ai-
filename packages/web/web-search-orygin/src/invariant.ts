/**
 * Package-owned invariant companion for `@orygin-ai/dsh-web-search-orygin`.
 * @module @orygin-ai/dsh-web-search-orygin/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-web-search-orygin'

/** Cordis companion plugin name. */
export const name = 'web-search-orygin-invariant'
