/**
 * `@orygin-ai/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@orygin-ai/dsh-llm-orygin`
 * registers an adapter into `ctx.llm`. The key is owned by `@orygin-ai/dsh-web`.
 *
 * @module @orygin-ai/dsh-web-search-exa
 */
