...
import type { WebSearchProvider, WebSearchResult } from '@orygin-ai/dsh-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@orygin-ai/dsh-web').WebFetchProvider
