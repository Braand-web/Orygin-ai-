...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@orygin-ai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@orygin-ai/dsh-web'
 ...
 * `@orygin-ai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@orygin-ai/dsh-tool-call-timeout-policy` to enforce.
