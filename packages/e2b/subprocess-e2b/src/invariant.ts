/**
 * Package-owned invariant companion for `@orygin-ai/dsh-subprocess-e2b`.
 * @module @orygin-ai/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-subprocess-e2b'
