 ...
 *
 * @module @orygin-ai/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@orygin-ai/dsh-shell'
import type { SandboxMode } from '@orygin-ai/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@orygin-ai/dsh-sandbox'
 ...
 * rendering story, owned by `@orygin-ai/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@orygin-ai/dsh-shell'
