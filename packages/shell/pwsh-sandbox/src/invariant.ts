/**
 * Package-owned invariant companion for `@orygin-ai/dsh-pwsh-sandbox`.
 * @module @orygin-ai/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-pwsh-sandbox'
