 ...
 * `@orygin-ai/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @orygin-ai/dsh-pwsh-sandbox
 */
...
import { SandboxUnavailableError } from '@orygin-ai/dsh-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
