/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-pwsh-persistent`.
 * @module @orygin-ai/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-pwsh-persistent'
