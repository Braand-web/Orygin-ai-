 ...
 * @module @orygin-ai/dsh-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@orygin-ai/dsh-terminal'
...
const SHELL_PROMPT = '__ORYGIN_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__ORYGIN_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__ORYGIN_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
