 ...
 *
 * @module @orygin-ai/dsh-pwsh-local
 */
...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@orygin-ai/dsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@orygin-ai/dsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@orygin-ai/dsh-subprocess'
import { installSettingsSection } from '@orygin-ai/dsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@orygin-ai/dsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@orygin-ai/dsh-pwsh-sandbox`.
