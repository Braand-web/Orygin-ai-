 ...
 * @module @orygin-ai/dsh-tool-bash-persistent
 */
...
import type { TerminalReadResult, TerminalSessionId } from '@orygin-ai/dsh-terminal'
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__ORYGIN_PERSISTENT_BASH_START_${nonce}__`,
    end: `__ORYGIN_PERSISTENT_BASH_END_${nonce}:`,
  }
}
