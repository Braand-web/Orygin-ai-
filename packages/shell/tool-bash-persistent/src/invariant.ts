/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-bash-persistent`.
 * @module @orygin-ai/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-bash-persistent'
