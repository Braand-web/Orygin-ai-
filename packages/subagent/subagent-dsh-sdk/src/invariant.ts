/**
 * Package-owned invariant companion for `@orygin-ai/dsh-subagent-dsh-sdk`.
 * @module @orygin-ai/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-subagent-dsh-sdk'
