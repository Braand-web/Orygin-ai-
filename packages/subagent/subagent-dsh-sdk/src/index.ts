/**
 * Out-of-process SDK subagent backend. Each child is a complete Orygin
 ...
 * @module @orygin-ai/dsh-subagent-dsh-sdk
 */

import type { Context } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import type { SubagentCapabilities, SubagentProvider, SubagentStartRequest } from '@orygin-ai/dsh-subagent'
import { assertPositiveFinite, NO_START_CAPABILITIES, resolveChildCwd, validateConfiguredCwd } from '@orygin-ai/dsh-subagent'
import {
...
export const Config: z<Config> = z.object({
  ...
  cwd: z.string(),
  provider: z.string().default('orygin-official'),
  model: z.string().default('orygin-v4-flash'),
