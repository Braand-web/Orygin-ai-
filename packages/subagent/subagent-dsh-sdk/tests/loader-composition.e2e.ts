...
import { resolveExampleLaunch, runLoaderSmoke } from '@orygin-ai/dsh-loader-smoke'
...
describe('SDK subagent cwd inheritance through a real cordis.yml', () => {
  it('runs the child runtime in the parent session workspace', async () => {
    ...
    const { stderr } = await runLoaderSmoke({
      ...
      env: {
        ORYGIN_TEST_CHILD_COMMAND: childLaunch.command,
        ORYGIN_TEST_CHILD_ARGS: JSON.stringify(childLaunch.args),
        ORYGIN_TEST_CHILD_ENV: JSON.stringify({
