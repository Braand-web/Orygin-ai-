/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-subagent`.
 * @module @orygin-ai/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-subagent'
