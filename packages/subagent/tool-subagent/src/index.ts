 ...
 * @module @orygin-ai/dsh-tool-subagent
 */

import type { Context } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { AgentOptions } from '@orygin-ai/dsh-agent'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import type { JsonValue } from '@orygin-ai/dsh-session'
import { assertSubagentMaxDepth, settleRun } from '@orygin-ai/dsh-subagent'
import type { SubagentProvider, SubagentResult, SubagentRun } from '@orygin-ai/dsh-subagent'
import type { JobOutcome } from '@orygin-ai/dsh-jobs'
