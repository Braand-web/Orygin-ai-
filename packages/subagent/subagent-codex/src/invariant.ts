/**
 * Package-owned invariant companion for `@orygin-ai/dsh-subagent-codex`.
 * @module @orygin-ai/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-subagent-codex'
