 ...
 *
 * @module @orygin-ai/dsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import type { SubagentResult } from '@orygin-ai/dsh-subagent'
import { JsonRpcLineTransport } from '@orygin-ai/dsh-sdk-protocol'
