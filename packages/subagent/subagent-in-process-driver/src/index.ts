 ...
 * one result.
 *
 * @module @orygin-ai/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@orygin-ai/cordis'
import { foldConsumedWork } from '@orygin-ai/dsh-agent'
...
import { createUserMessage, type ContentBlock } from '@orygin-ai/dsh-llm'
import {
