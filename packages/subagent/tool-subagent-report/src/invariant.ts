/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-subagent-report`.
 * @module @orygin-ai/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-subagent-report'
