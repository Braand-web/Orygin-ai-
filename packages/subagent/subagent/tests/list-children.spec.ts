...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@orygin-ai/dsh-session'
import type { SessionEvent, SessionHeader } from '@orygin-ai/dsh-session'
...
import type { ProjectionDefinition } from '@orygin-ai/dsh-session-projection'
import SessionProjectionCache from '@orygin-ai/dsh-session-projection-cache'
import Storage from '@orygin-ai/dsh-storage'
import { DomainFacility } from '@orygin-ai/dsh-storage-domain'
import { MemoryMediaPool, MemoryStorageBackend } from '../../../storage/storage-domain/tests/helpers/memory-backend.ts'
import SubagentRuntime, {
  SUBAGENT_DESCRIPTOR_VERSION,
  SubagentError,
} from '@orygin-ai/dsh-subagent'
import * as SubagentSpawn from '@orygin-ai/dsh-subagent-spawn-in-process'
import * as SubagentFork from '@orygin-ai/dsh-subagent-fork-in-process'
...
declare module '@orygin-ai/dsh-session-projection/types' {
