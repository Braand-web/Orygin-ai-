...
import type { SessionProjectionRegistry } from '@orygin-ai/dsh-session-projection'
import type { SessionProjectionCache } from '@orygin-ai/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @orygin-ai/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @orygin-ai/dsh-session)',
