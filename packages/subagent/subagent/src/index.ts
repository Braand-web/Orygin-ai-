 ...
 * (`@orygin-ai/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@orygin-ai/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@orygin-ai/dsh-tools'
import type { ContentBlock, MessageId } from '@orygin-ai/dsh-llm'
