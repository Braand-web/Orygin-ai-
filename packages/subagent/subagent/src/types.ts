 ...
 *
 * @module @orygin-ai/dsh-subagent/types
 */

import type { Agent, AgentOptions } from '@orygin-ai/dsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@orygin-ai/dsh-tools'
