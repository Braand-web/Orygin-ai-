/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-subagent-control`.
 * @module @orygin-ai/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-subagent-control'
