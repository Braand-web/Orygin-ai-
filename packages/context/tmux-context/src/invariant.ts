/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tmux-context`.
 * @module @orygin-ai/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tmux-context'
