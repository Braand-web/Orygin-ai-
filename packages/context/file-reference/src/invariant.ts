/**
 * Package-owned invariant companion for `@orygin-ai/dsh-file-reference`.
 * @module @orygin-ai/dsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-file-reference'
