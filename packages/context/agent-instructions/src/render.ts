 ...
 *
 * @module @orygin-ai/dsh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$ORYGIN_HOME`.
 * Discovery (`$ORYGIN_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.dsh/AGENTS.md' || displayPath === '$ORYGIN_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
