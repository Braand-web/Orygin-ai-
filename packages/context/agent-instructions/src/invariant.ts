/**
 * Package-owned invariant companion for `@orygin-ai/dsh-agent-instructions`.
 * @module @orygin-ai/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-agent-instructions'
