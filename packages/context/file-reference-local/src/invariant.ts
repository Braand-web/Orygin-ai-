/**
 * Package-owned invariant companion for `@orygin-ai/dsh-file-reference-local`.
 * @module @orygin-ai/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-file-reference-local'
