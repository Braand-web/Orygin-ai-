 ...
 *
 * @module @orygin-ai/dsh-file-reference-local
 */
...
} from '@orygin-ai/dsh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@orygin-ai/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@orygin-ai/dsh-file-reference/grammar'
