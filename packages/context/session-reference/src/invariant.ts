/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-reference`.
 * @module @orygin-ai/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-reference'
