...
Point the shipping Orygin adapter at the server; it appends `/chat/completions` to the configured base:

```sh
ORYGIN_BASE_URL=http://127.0.0.1:8000/v1 \
ORYGIN_API_KEY=mock-key \
