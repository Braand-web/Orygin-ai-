/**
 * Package-owned invariant companion for `@orygin-ai/dsh-llm-mock-server`.
 * @module @orygin-ai/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-llm-mock-server'
