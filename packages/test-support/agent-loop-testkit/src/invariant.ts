/**
 * Package-owned invariant companion for `@orygin-ai/dsh-agent-loop-testkit`.
 * @module @orygin-ai/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-agent-loop-testkit'
