/**
 * Package-owned invariant companion for `@orygin-ai/dsh-acp-snapshot`.
 * @module @orygin-ai/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-acp-snapshot'
