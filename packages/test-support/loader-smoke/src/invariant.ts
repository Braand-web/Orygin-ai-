/**
 * Package-owned invariant companion for `@orygin-ai/dsh-loader-smoke`.
 * @module @orygin-ai/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-loader-smoke'
