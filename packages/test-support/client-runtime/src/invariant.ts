/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-test-runtime`.
 * @module @orygin-ai/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-test-runtime'
