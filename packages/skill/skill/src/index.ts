 ...
 * Concrete
 * providers such as `@orygin-ai/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @orygin-ai/dsh-skill
 */

import { Context, Service } from '@orygin-ai/cordis'
import { assertNever } from '@orygin-ai/dsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@orygin-ai/dsh-scope'
