 ...
 *
 * @module @orygin-ai/dsh-compaction-basic
 */

import { Context } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { CompactionEngine, ManualCompactionError } from '@orygin-ai/dsh-compaction'
import type { CompactionResult, CompactionTrigger } from '@orygin-ai/dsh-compaction'
import type { TokenMeter } from '@orygin-ai/dsh-token-meter'
import type { Session } from '@orygin-ai/dsh-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@orygin-ai/dsh-llm'
import type { LlmCallConfig } from '@orygin-ai/dsh-llm'
import type { Agent, PreStepDecision } from '@orygin-ai/dsh-agent'
import type { CommandId } from '@orygin-ai/dsh-commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@orygin-ai/dsh-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
