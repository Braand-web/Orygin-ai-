/**
 * Package-owned invariant companion for `@orygin-ai/dsh-command-compact`.
 * @module @orygin-ai/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-command-compact'
