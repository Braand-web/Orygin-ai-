...
import * as invariant from '@orygin-ai/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@orygin-ai/dsh-command-compact', expect.any(Function))
    expect(() => {
