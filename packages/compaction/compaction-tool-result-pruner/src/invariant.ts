/**
 * Package-owned invariant companion for `@orygin-ai/dsh-compaction-tool-result-pruner`.
 * @module @orygin-ai/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-compaction-tool-result-pruner'
