...
import { CallId , createMessage, createToolResultMessage } from '@orygin-ai/dsh-llm'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import SessionStore, {
  Session,
  SessionId,
} from '@orygin-ai/dsh-session'
import type { SurfaceEvent } from '@orygin-ai/dsh-session'
...
import ToolResultPruner, {
  ...
  PRUNE_MARKER,
  resolveConfig,
} from '@orygin-ai/dsh-compaction-tool-result-pruner'
import type { ToolResultPruneConfig } from '@orygin-ai/dsh-compaction-tool-result-pruner'
