/** Package-owned compaction log-stream invariants. @module @orygin-ai/dsh-compaction/invariant */

import type { Context } from '@orygin-ai/cordis'
import { isReplacementSurfaceEvent } from '@orygin-ai/dsh-session'
...
const PACKAGE_NAME = '@orygin-ai/dsh-compaction'
