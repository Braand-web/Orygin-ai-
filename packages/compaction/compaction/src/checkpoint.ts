 ...
 *
 * The seam itself lives in `@orygin-ai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @orygin-ai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@orygin-ai/dsh-llm/message'
