/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-title-llm`.
 * @module @orygin-ai/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-title-llm'
