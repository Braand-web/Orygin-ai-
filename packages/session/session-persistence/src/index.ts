 ...
 * @module @orygin-ai/dsh-session-persistence
 */

import { Context, Service } from '@orygin-ai/cordis'
import { SessionPreparation } from '@orygin-ai/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@orygin-ai/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@orygin-ai/dsh-session'
