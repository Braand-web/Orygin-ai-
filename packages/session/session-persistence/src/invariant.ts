/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-persistence`.
 * @module @orygin-ai/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-persistence'
