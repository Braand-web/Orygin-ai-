/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-telemetry`.
 * @module @orygin-ai/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-telemetry'
