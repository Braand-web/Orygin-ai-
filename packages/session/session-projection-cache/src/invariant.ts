/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-projection-cache`.
 * @module @orygin-ai/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-projection-cache'
