/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-stats`.
 * @module @orygin-ai/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-stats'
