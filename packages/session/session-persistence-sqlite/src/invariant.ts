/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-persistence-sqlite`.
 * @module @orygin-ai/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-persistence-sqlite'
