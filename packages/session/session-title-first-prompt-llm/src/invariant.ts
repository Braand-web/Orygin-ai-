/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-title-first-prompt-llm`.
 * @module @orygin-ai/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-title-first-prompt-llm'
