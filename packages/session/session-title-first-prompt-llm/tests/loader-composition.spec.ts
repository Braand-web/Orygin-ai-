...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@orygin-ai/dsh-llm'
import type { GenerateOptions, StreamChunk } from '@orygin-ai/dsh-llm'
import SessionStore, { SessionId } from '@orygin-ai/dsh-session'
import SessionTitleService from '@orygin-ai/dsh-session-title'
import * as providerPlugin from '@orygin-ai/dsh-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@orygin-ai/dsh-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@orygin-ai/dsh-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@orygin-ai/dsh-session-title', SessionTitleService],
    ['@orygin-ai/dsh-session-title-first-prompt-llm', providerPlugin],
  ])
