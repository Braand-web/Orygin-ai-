/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-title-all-prompts-llm`.
 * @module @orygin-ai/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-title-all-prompts-llm'
