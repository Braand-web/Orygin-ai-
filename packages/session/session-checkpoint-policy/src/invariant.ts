/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-checkpoint-policy`.
 * @module @orygin-ai/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-checkpoint-policy'
