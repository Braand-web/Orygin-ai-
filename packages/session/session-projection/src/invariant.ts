/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-projection`.
 * @module @orygin-ai/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-projection'
