/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-telemetry-otel`.
 * @module @orygin-ai/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-telemetry-otel'
