/**
 * OpenTelemetry Service Provider for the Orygin telemetry capability.
 *
 ...
 *
 * @module @orygin-ai/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@orygin-ai/schemastery'
import type { Context } from '@orygin-ai/cordis'
import type {} from '@orygin-ai/dsh-command-feedback'
import {
...
} from '@orygin-ai/dsh-session-telemetry'
import { APP_IDENTITY } from '@orygin-ai/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@orygin-ai/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@orygin-ai/dsh-session-telemetry-otel/ops', version)
