/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-title`.
 * @module @orygin-ai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-title'
