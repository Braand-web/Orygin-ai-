 ...
 * @module @orygin-ai/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@orygin-ai/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@orygin-ai/dsh-llm'
import type { GenerateOptions } from '@orygin-ai/dsh-llm'
import type {
  Session,
  SessionEvent,
