import { MessageId, createUserMessage, createMessage } from '@orygin-ai/dsh-llm'
...
import type { Session, SessionEvent, SessionHeader } from '@orygin-ai/dsh-session'
...
describe('JsonlSessionPersistence: format helpers', () => {
  ...
  it('projectKey normalizes project paths into bounded readable names', () => {
    expect(projectKey('/Users/qyj/work/orygin-ai')).toBe('--Users-qyj-work-orygin-ai--')
