/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-persistence-jsonl`.
 * @module @orygin-ai/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-persistence-jsonl'
