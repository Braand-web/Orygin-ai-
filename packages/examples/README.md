...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@orygin-ai/dsh-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@orygin-ai/dsh-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@orygin-ai/dsh-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
