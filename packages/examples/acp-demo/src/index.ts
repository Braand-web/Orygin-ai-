 ...
 * ({@link @orygin-ai/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @orygin-ai/dsh-acp} bridge. The app owns those plugins through one
...
} from '@orygin-ai/dsh-session-persistence-jsonl'
