/**
 * Package-owned invariant companion for `@orygin-ai/dsh-agent-spine-demo`.
 * @module @orygin-ai/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-agent-spine-demo'
