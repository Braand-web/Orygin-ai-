 ...
 * @module @orygin-ai/dsh-agent-spine-demo
 */

import type { Context } from '@orygin-ai/cordis'
import Timer from '@orygin-ai/cordis-plugin-timer'
import z from '@orygin-ai/schemastery'
import LlmRuntime from '@orygin-ai/dsh-llm'
import SessionStore from '@orygin-ai/dsh-session'
import SessionTitleService, { type Config as SessionTitleConfig } from '@orygin-ai/dsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@orygin-ai/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@orygin-ai/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@orygin-ai/dsh-skill'
import * as SkillFileSystem from '@orygin-ai/dsh-skill-filesystem'
import AgentRegistry from '@orygin-ai/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@orygin-ai/dsh-goal'
import * as goalSession from '@orygin-ai/dsh-goal-round-driver'
import * as toolGoal from '@orygin-ai/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@orygin-ai/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@orygin-ai/dsh-invariants'
import * as sessionInvariant from '@orygin-ai/dsh-session/invariant'
import * as agentInvariant from '@orygin-ai/dsh-agent/invariant'
import * as scopeInvariant from '@orygin-ai/dsh-scope/invariant'
import * as agentLoopInvariant from '@orygin-ai/dsh-agent-loop/invariant'
import * as toolBash from '@orygin-ai/dsh-tool-bash'
import * as bashEnv from '@orygin-ai/dsh-shell-env'
import * as workspaceContext from '@orygin-ai/dsh-agent-instructions'
import * as toolSkill from '@orygin-ai/dsh-tool-skill'
import * as toolJobs from '@orygin-ai/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@orygin-ai/dsh-agent-loop'
import * as llmRetry from '@orygin-ai/dsh-llm-retry'
