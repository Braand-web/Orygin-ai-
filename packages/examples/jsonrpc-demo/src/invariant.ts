/**
 * Package-owned invariant companion for `@orygin-ai/dsh-sdk-jsonrpc-demo`.
 * @module @orygin-ai/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-sdk-jsonrpc-demo'
