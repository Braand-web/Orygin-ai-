 ...
 * @module @orygin-ai/dsh-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@orygin-ai/cordis'
import s from '@orygin-ai/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@orygin-ai/dsh-session/surface'
import type { SessionHeader, SessionId } from '@orygin-ai/dsh-session/types'
import type { SessionInspection } from '@orygin-ai/dsh-session-persistence'
import type { KvTable } from '@orygin-ai/dsh-storage-domain'
