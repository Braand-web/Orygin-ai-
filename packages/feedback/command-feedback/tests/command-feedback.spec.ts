...
import SessionStore, { foldSurface, Session, SessionId } from '@orygin-ai/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@orygin-ai/dsh-session-telemetry'
...
vi.mock('@orygin-ai/dsh-anonymous-user-id', () => ({
...
describe('@orygin-ai/dsh-command-feedback registration', () => {
