/**
 * Package-owned invariant companion for `@orygin-ai/dsh-command-feedback`.
 * @module @orygin-ai/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-command-feedback'
