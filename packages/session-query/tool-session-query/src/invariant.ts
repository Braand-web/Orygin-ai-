/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-session-query`.
 * @module @orygin-ai/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-session-query'
