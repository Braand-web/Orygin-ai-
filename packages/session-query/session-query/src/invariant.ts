/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-query`.
 * @module @orygin-ai/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-query'
