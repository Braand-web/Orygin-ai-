...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@orygin-ai/dsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@orygin-ai/dsh-session'
