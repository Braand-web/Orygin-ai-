/**
 * Package-owned invariant companion for `@orygin-ai/dsh-session-query-sqlite`.
 * @module @orygin-ai/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-session-query-sqlite'
