import { createAssistantMessage, createUserMessage } from '@orygin-ai/dsh-llm'
import { afterEach, describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@orygin-ai/cordis'
import { DatabaseSync } from 'node:sqlite'
import { chmod, mkdtemp, rm, stat, writeFile } from 'node:fs/promises'
import { tmpdir } from 'node:os'
import { dirname, join } from 'node:path'
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@orygin-ai/dsh-session'
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@orygin-ai/dsh-session'
import SessionPersistence, { SessionPersistenceRevision } from '@orygin-ai/dsh-session-persistence'
import type { SessionPersistenceSnapshot } from '@orygin-ai/dsh-session-persistence'
import SqliteSessionPersistence from '@orygin-ai/dsh-session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@orygin-ai/dsh-session-query-sqlite'
import {
...
} from '@orygin-ai/dsh-session-query'
