/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-cordis`.
 * @module @orygin-ai/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-cordis'
