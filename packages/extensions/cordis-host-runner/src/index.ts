 ...
 * @module @orygin-ai/dsh-cordis-host-runner
 */
...
import type { JsonValue } from '@orygin-ai/dsh-session/types'
...
function missingPluginMessage(id: CordisDynamicPluginId): string {
  return `no dynamic plugin "${id}" in this process — it may have been removed or lost on ORYGIN restart`
}
