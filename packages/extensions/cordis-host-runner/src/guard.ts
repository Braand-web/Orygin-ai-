 ...
 * @module @orygin-ai/dsh-cordis-host-runner/guard
 */

import { Context } from '@orygin-ai/cordis'
import type { Plugin } from '@orygin-ai/cordis'
import { scopeOf } from '@orygin-ai/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@orygin-ai/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@orygin-ai/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
