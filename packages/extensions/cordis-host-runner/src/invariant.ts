/**
 * Package-owned invariant companion for `@orygin-ai/dsh-cordis-host-runner`.
 * @module @orygin-ai/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-cordis-host-runner'
