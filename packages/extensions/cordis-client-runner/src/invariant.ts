/**
 * Package-owned invariant companion for `@orygin-ai/dsh-cordis-client-runner`.
 * @module @orygin-ai/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-cordis-client-runner'
