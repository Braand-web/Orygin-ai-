 ...
 * @module @orygin-ai/dsh-tool-cordis
 */
...
} from '@orygin-ai/dsh-cordis-host-runner'
import type { DynamicCordisReference } from '@orygin-ai/dsh-cordis-host-runner'
import { createUserMessage } from '@orygin-ai/dsh-llm'
import type { JsonValue } from '@orygin-ai/dsh-session'
import type { UserMessage } from '@orygin-ai/dsh-session'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the ORYGIN process restarted.',
