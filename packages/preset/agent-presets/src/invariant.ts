/**
 * Package-owned invariant companion for `@orygin-ai/dsh-agent-presets`.
 * @module @orygin-ai/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@orygin-ai/dsh-agent-presets'

const PACKAGE_NAME = '@orygin-ai/dsh-agent-presets'
