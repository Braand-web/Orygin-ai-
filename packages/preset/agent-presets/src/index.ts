 ...
 * @module @orygin-ai/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@orygin-ai/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@orygin-ai/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@orygin-ai/dsh-settings'
