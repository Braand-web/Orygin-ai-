 ...
 * @module @orygin-ai/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@orygin-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@orygin-ai/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@orygin-ai/dsh-*` row would fail to import. The
