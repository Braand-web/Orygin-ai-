/**
 * Package-owned invariant companion for `@orygin-ai/dsh-storage-domain`: every
 ...
 * @module @orygin-ai/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-storage-domain'
