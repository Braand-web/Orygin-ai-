/**
 * Package-owned invariant companion for `@orygin-ai/dsh-storage-sqlite`.
 * @module @orygin-ai/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-storage-sqlite'
