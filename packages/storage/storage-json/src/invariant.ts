/**
 * Package-owned invariant companion for `@orygin-ai/dsh-storage-json`.
 * @module @orygin-ai/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-storage-json'
