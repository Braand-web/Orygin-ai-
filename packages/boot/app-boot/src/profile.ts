 ...
 *
 * A profile is a directory under `$ORYGIN_HOME/profiles/<name>` holding a
 ...
 * flat fallback directory `$ORYGIN_HOME/profiles/node_modules` (one symlink per
 ...
 * @module @orygin-ai/dsh-app-boot/profile
 */
...
import { applyEntryPatches, type PatchOptions } from '@orygin-ai/cordis-plugin-include'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@orygin-ai/dsh-base', '@orygin-ai/dsh-web-app'],
  headless: ['@orygin-ai/dsh-base', '@orygin-ai/dsh-headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@orygin-ai/dsh-base', '@orygin-ai/dsh-web-app', '@orygin-ai/dsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@orygin-ai/dsh-base']
...
/**
 * Maintain the flat module fallback `$ORYGIN_HOME/profiles/node_modules`: one
 ...
 * `@orygin-ai/dsh-base` (and every other in-box bundle) always comes from
