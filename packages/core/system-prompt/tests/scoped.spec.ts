...
import { createScope, scopeOf } from '@orygin-ai/dsh-scope'
import type { Scope, ScopeKey } from '@orygin-ai/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@orygin-ai/dsh-system-prompt'
import type { Config, PromptAssembly } from '@orygin-ai/dsh-system-prompt'
