 ...
 * @module @orygin-ai/dsh-agent-loop/invariant
 */

import type { Context } from '@orygin-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@orygin-ai/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@orygin-ai/dsh-invariants'
import { foldRequestHeader } from '@orygin-ai/dsh-session'

const PACKAGE_NAME = '@orygin-ai/dsh-agent-loop'
