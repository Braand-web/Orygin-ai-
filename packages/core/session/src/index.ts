 ...
 *
 * @module @orygin-ai/dsh-session
 */

import { Context, Service } from '@orygin-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@orygin-ai/dsh-llm'
import { scopeOf, scopeTarget } from '@orygin-ai/dsh-scope'
import type { Scoped } from '@orygin-ai/dsh-scope'
import type { Message } from '@orygin-ai/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@orygin-ai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@orygin-ai/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@orygin-ai/dsh-session#Session',
        wireTypeSymbol: '@orygin-ai/dsh-session/types#SessionId',
