 ...
 * whose JSON envelopes dwarf their payloads (~56× measured on a real Orygin
 ...
 *
 * @module @orygin-ai/dsh-session/chunk-rows
 */

import { CallId, assertNever } from '@orygin-ai/dsh-llm'
