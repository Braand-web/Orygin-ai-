/**
 * Package-owned invariant companion for `@orygin-ai/dsh-agent-tool-presentation`.
 * @module @orygin-ai/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-agent-tool-presentation'
