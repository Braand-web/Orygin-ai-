...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@orygin-ai/dsh-llm'
import SystemPrompt from '@orygin-ai/dsh-system-prompt'
import type { Agent } from '@orygin-ai/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@orygin-ai/dsh-user-approval'
import ToolRuntime, {
