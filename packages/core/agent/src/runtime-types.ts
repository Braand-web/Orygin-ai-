 ...
 * turn/step boundaries remain `@orygin-ai/dsh-session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@orygin-ai/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@orygin-ai/dsh-session'
export type { AgentCancelCause } from '@orygin-ai/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@orygin-ai/dsh-system-prompt'
declare module '@orygin-ai/dsh-system-prompt' {
...
declare module '@orygin-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@orygin-ai/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
