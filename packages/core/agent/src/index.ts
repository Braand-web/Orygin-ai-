 ...
 *
 * @module @orygin-ai/dsh-agent
 */

import { Context, FiberState, getTraceable, Service, symbols } from '@orygin-ai/cordis'
...
import type { SessionEvent, SessionId } from '@orygin-ai/dsh-session'
import type { TypertContext, TypertLookup } from '@orygin-ai/dsh-typert-protocol'
 ...
 * (`@orygin-ai/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@orygin-ai/dsh-agent#Agent',
