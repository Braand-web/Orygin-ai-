/** Package-owned scoped-dispatch invariants. @module @orygin-ai/dsh-scope/invariant */

import type { Context } from '@orygin-ai/cordis'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@orygin-ai/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@orygin-ai/dsh-scope'
