 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the Orygin function-name
...
import { isImageAdmissionError } from '@orygin-ai/dsh-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@orygin-ai/dsh-attachment'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@orygin-ai/dsh-tools'
import { assertSupportedJsonSchema } from '@orygin-ai/dsh-tools'
import type { JsonSchemaNode, JsonValue } from '@orygin-ai/dsh-tools'
...
/**
 * Orygin function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** Orygin function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the Orygin function-name contract (64 chars,
