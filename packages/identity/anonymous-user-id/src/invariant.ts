/**
 * Package-owned invariant companion for `@orygin-ai/dsh-anonymous-user-id`.
 * @module @orygin-ai/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-anonymous-user-id'
