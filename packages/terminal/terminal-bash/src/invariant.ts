/**
 * Package-owned invariant companion for `@orygin-ai/dsh-terminal-bash`.
 * @module @orygin-ai/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-terminal-bash'
