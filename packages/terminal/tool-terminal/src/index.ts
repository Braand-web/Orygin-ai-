 ...
 * @module @orygin-ai/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@orygin-ai/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@orygin-ai/dsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @orygin-ai/dsh-jobs and @orygin-ai/dsh-tool-jobs')
