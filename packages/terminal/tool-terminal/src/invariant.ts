/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-terminal`.
 * @module @orygin-ai/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-terminal'
