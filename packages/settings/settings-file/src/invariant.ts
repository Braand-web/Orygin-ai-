/**
 * Package-owned invariant companion for `@orygin-ai/dsh-settings-file`.
 * @module @orygin-ai/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@orygin-ai/dsh-settings`.
 */
