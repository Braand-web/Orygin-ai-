/**
 * Package-owned invariant companion for `@orygin-ai/dsh-jobs-local`.
 * @module @orygin-ai/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-jobs-local'
...
/**
 * No runtime invariant: `@orygin-ai/dsh-jobs/invariant` owns per-snapshot identity, status,
