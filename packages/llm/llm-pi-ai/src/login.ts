...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@orygin-ai/dsh-authorization'
import { isCredentialKeySegment } from '@orygin-ai/dsh-credentials'
