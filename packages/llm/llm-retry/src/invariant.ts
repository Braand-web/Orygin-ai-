/** Package-owned durable retry-event invariants. @module @orygin-ai/dsh-llm-retry/invariant */

import type { Context } from '@orygin-ai/cordis'
import type { Session, SessionEvent } from '@orygin-ai/dsh-session'
import type { LlmFailure } from '@orygin-ai/dsh-llm'
...
const PACKAGE_NAME = '@orygin-ai/dsh-llm-retry'
