/**
 * Translate Orygin SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate Orygin wire chunks into the harness `StreamChunk` protocol.
 * @module dsh-llm-orygin/translate
 */

import { CallId, EMPTY_RESPONSE_CODE, LlmError } from '@orygin-ai/dsh-llm'
import type { ContentBlock, FinishReason, StreamChunk, TokenUsage } from '@orygin-ai/dsh-llm'
...
/**
 * Map wire usage fields. Orygin's `prompt_tokens` INCLUDES cache hits
