 ...
 * Orygin protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module dsh-llm-orygin/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@orygin-ai/dsh-llm'

/** The terminal payload Orygin (and OpenAI) send after the last chunk. */
