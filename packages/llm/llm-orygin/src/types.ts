/**
 * Orygin chat-completions wire format (OpenAI-compatible). Types only.
 *
...
export interface WireAssistantMessage {
   ...
   * guides/thinking_mode.mdx § Tool Calls); Orygin ignores it elsewhere,
