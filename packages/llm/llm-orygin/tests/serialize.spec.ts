...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@orygin-ai/dsh-attachment'
import { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@orygin-ai/dsh-llm'
...
function request(overrides: Partial<GenerateOptions> = {}): GenerateOptions {
  return { provider: 'orygin-official', model: 'orygin-v4-flash', messages: [], ...overrides }
}
...
describe('serializeRequest', () => {
  ...
  it('rejects an effort outside the Orygin capability', () => {
