...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@orygin-ai/dsh-llm'
import type { AppIdentity } from '@orygin-ai/dsh-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `orygin-ai/${manifest.version} (+https://github.com/Braand-web/Orygin-ai-)`,
    )
  })
