...
/**
 * Establish this process's proof that one ORYGIN_HOME entry and every ancestor
 ...
 * @param root - absolute `ORYGIN_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish ORYGIN_HOME itself against the filesystem root once per process.
