/** Package-owned invariant companion for `@orygin-ai/dsh-attachment-local`. @module @orygin-ai/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@orygin-ai/cordis'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-attachment-local'
