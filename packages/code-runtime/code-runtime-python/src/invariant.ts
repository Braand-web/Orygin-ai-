/**
 * Package-owned invariant companion for `@orygin-ai/dsh-code-runtime-python`.
 * @module @orygin-ai/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-code-runtime-python'
