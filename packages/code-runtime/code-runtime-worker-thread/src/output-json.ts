/** JSON string-prefix accounting for the outer-output ledger. @module @orygin-ai/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@orygin-ai/dsh-code-runtime'
