/**
 * Package-owned invariant companion for `@orygin-ai/dsh-code-runtime-worker-thread`.
 * @module @orygin-ai/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-code-runtime-worker-thread'
