/**
 * @orygin-ai/dsh-headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@orygin-ai/dsh-agent'
import type {} from '@orygin-ai/dsh-agent-default-model'
...
import type {} from '@orygin-ai/dsh-cmdline'
