/**
 * Package-owned invariant companion for `@orygin-ai/dsh-typert-registry`.
 * @module @orygin-ai/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-typert-registry'
