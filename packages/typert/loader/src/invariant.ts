/**
 * Package-owned invariant companion for `@orygin-ai/dsh-typert-loader`.
 * @module @orygin-ai/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-typert-loader'
