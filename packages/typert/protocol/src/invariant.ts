/**
 * Package-owned invariant companion for `@orygin-ai/dsh-typert-protocol`.
 * @module @orygin-ai/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-typert-protocol'
