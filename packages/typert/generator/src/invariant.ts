/**
 * Package-owned invariant companion for `@orygin-ai/dsh-typert-generator`.
 * @module @orygin-ai/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-typert-generator'
