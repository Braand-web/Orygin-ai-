/**
 * Package-owned invariant companion for `@orygin-ai/dsh-authorization`.
 * @module @orygin-ai/dsh-authorization/invariant
 */

import type { Context } from '@orygin-ai/cordis'
import type { InvariantFailure, InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-authorization'
