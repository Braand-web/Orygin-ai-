...
const ALPHA = credentialRef('ORYGIN_REVIEW_ALPHA')
const BETA = credentialRef('ORYGIN_REVIEW_BETA')
const INNER = credentialRef('ORYGIN_REVIEW_INNER')
