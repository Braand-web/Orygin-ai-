/**
 * Package-owned invariant companion for `@orygin-ai/dsh-credentials-local`.
 * @module @orygin-ai/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-credentials-local'
