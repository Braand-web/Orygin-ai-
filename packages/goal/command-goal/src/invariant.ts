/**
 * Package-owned invariant companion for `@orygin-ai/dsh-command-goal`.
 * @module @orygin-ai/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-command-goal'
