 ...
 * @module @orygin-ai/dsh-tool-goal
 */

import type { Context } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { GoalId } from '@orygin-ai/dsh-goal'
import type { GoalRef, GoalView } from '@orygin-ai/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@orygin-ai/dsh-llm'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { GenericCallView } from '@orygin-ai/dsh-tools'
