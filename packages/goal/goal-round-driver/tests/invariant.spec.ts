...
import * as GoalSessionInvariant from '@orygin-ai/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@orygin-ai/dsh-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@orygin-ai/dsh-goal-round-driver',
    }))
  })
