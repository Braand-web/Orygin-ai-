/** Package-owned goal-round prompt invariants. @module @orygin-ai/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@orygin-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@orygin-ai/dsh-goal'
import type { InvariantFailure, InvariantInstaller } from '@orygin-ai/dsh-invariants'
import type { Session, SessionEvent } from '@orygin-ai/dsh-session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@orygin-ai/dsh-goal-round-driver'
