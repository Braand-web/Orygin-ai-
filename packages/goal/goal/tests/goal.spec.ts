...
import { createUserMessage, HarnessError } from '@orygin-ai/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@orygin-ai/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@orygin-ai/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@orygin-ai/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@orygin-ai/dsh-session').SessionEvent[]): StubAgent {
