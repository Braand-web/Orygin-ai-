/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-workspace`.
 * @module @orygin-ai/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-workspace'
