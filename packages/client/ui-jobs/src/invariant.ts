/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-jobs`.
 * @module @orygin-ai/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-jobs'
