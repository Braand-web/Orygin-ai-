/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-user-questions`.
 * @module @orygin-ai/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-user-questions'
