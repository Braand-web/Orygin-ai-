/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-deliverables`.
 * @module @orygin-ai/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-deliverables'
