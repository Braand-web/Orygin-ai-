...
import { apply as applyLocale, inject as localeInject } from '@orygin-ai/dsh-client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from '@orygin-ai/dsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@orygin-ai/dsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@orygin-ai/dsh-client-ui-deliverables'])
