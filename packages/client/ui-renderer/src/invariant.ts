/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-renderer`.
 * @module @orygin-ai/dsh-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-renderer'
