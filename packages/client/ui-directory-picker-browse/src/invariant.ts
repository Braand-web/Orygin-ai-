/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-directory-picker-browse`.
 * @module @orygin-ai/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-directory-picker-browse'
