/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-locale`.
 * @module @orygin-ai/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-locale'
