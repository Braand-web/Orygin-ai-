...
import type { ClientContext, SettingsScope } from '@orygin-ai/dsh-client-runtime/client'
...
export type { Translate, TranslateNS } from '@orygin-ai/dsh-client-ui-slots'
...
export class LocaleRuntime {
   ...
   * different browser sharing the same ORYGIN home. Only the render notification
