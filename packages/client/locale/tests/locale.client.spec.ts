...
import type { LocaleSettings, LocaleSnapshot } from '@orygin-ai/dsh-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@orygin-ai/dsh-client-locale/client'
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared ORYGIN home agrees', () => {
