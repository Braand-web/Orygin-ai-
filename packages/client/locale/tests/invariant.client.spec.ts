...
import { apply as nodeApply } from '@orygin-ai/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@orygin-ai/dsh-client-locale/client'
import * as LocaleInvariant from '@orygin-ai/dsh-client-locale/invariant'
