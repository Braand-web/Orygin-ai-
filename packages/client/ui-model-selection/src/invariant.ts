/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-model-selection`.
 * @module @orygin-ai/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-model-selection'
