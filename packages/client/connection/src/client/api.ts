...
export type { ToolCallView, ToolResultView } from '@orygin-ai/dsh-tools/presentation'
export type {
...
export { AbstractApiClient } from '@orygin-ai/dsh-host-apiproxy/client'
export type { IApiClient } from '@orygin-ai/dsh-host-apiproxy/client'
export type { SessionId, SessionEvent } from '@orygin-ai/dsh-session/types'
export type { MessageId } from '@orygin-ai/dsh-llm/brand'
export type { ContentBlock, StreamChunk } from '@orygin-ai/dsh-llm/types'

/** Successful value returned by the connection-generation host handshake. */
export type HostDescription = import('@orygin-ai/dsh-host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@orygin-ai/dsh-host-apiproxy/api'
