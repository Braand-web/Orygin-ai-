/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-connection`.
 * @module @orygin-ai/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-connection'
