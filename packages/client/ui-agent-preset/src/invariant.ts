/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-agent-preset`.
 * @module @orygin-ai/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-agent-preset'
