 ...
 */
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@orygin-ai/dsh-client-ui-slots'
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry) into every
// program that sees this contract, so PropsRuntime<'sidebar'> resolves.
import type {} from '@orygin-ai/dsh-client-ui-layout/client'
import type { WorkspaceId } from '@orygin-ai/dsh-client-runtime/client'
