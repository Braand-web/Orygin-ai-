            ...
            <span className={css.brandIdentity} aria-hidden="true">
              ...
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: (
                    <>
                      <span className={css.fallbackBrandName}>ORYGIN Local Build</span>
                      {process.env.ORYGIN_CLIENT_COMMIT_HASH
                        ? <span className={css.buildRevision}>{process.env.ORYGIN_CLIENT_COMMIT_HASH}</span>
                        : null}
                    </>
                  ),
                })}
