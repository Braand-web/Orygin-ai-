/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-sidebar`.
 * @module @orygin-ai/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-sidebar'
