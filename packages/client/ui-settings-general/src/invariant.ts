/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-settings-general`.
 * @module @orygin-ai/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-settings-general'
