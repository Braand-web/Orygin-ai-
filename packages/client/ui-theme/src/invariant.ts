/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-theme`.
 * @module @orygin-ai/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-theme'
