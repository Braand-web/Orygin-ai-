...
import * as Cordis from '@orygin-ai/cordis'
import * as UiSlots from '@orygin-ai/dsh-client-ui-slots'
import * as UiPrimitives from '@orygin-ai/dsh-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@orygin-ai/cordis': Cordis,
    '@orygin-ai/dsh-client-ui-slots': UiSlots,
    '@orygin-ai/dsh-client-ui-primitives': UiPrimitives,
