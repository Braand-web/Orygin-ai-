/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-primitives`.
 * @module @orygin-ai/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-primitives'
