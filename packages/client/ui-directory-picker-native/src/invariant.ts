/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-directory-picker-native`.
 * @module @orygin-ai/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-directory-picker-native'
