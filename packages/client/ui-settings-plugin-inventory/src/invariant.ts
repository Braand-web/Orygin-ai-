/** Package-owned invariant companion. @module @orygin-ai/dsh-client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@orygin-ai/cordis'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-settings-plugin-inventory'
