/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-tool`.
 * @module @orygin-ai/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-tool'
