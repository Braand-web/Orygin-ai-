...
import type { SessionProviderComponent, TranslateNS } from '@orygin-ai/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@orygin-ai/dsh-client-ui-conversation/src/client/contract/slots.ts'
