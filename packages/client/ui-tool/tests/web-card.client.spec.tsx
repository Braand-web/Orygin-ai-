...
import type { ToolResultView } from '@orygin-ai/dsh-api-remotes/client'
import { bindSnapshotSelector } from '@orygin-ai/dsh-client-test-runtime'
import type { SelectionTarget } from '@orygin-ai/dsh-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@orygin-ai/dsh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@orygin-ai/dsh-client-ui-primitives'
...
import { DetailsPanel } from '@orygin-ai/dsh-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
import { WebRow, webToolview } from '../src/client/tool/toolviews/web-row.tsx'
import { renderToolDetails, SessionProviderStub, toolChatSnapshot } from './tool-details-render.client.tsx'
import { makeTranslate } from '@orygin-ai/dsh-client-test-runtime'
import { zh as commonZh } from '@orygin-ai/dsh-client-locale/src/locales/zh.ts'
import { zh } from '@orygin-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
const SEARCH_ARGS = '{"query":"orygin harness"}'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@orygin-ai/cordis').Context
