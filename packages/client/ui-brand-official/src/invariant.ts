/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-brand-official`.
 * @module @orygin-ai/dsh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-brand-official'
