/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-settings-models`.
 * @module @orygin-ai/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-settings-models'
