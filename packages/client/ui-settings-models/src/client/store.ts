...
} from '@orygin-ai/dsh-api-remotes/client'
...
import type { SettingsDescribeFace } from '@orygin-ai/dsh-client-ui-settings/client'
 ...
 * Orygin route — the one route the prompt can offer a key field for — decide
