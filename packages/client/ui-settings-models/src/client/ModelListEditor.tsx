...
import type { DiscoveredModelView, IApiClient } from '@orygin-ai/dsh-api-remotes/client'
import { Button, Modal } from '@orygin-ai/dsh-client-ui-primitives'
import { formatCapacity, parseCapacity } from './OryginModelsEditor.tsx'
import type { OryginModelDraft } from './OryginModelsEditor.tsx'
import { messageOf } from './store.ts'
import type { en } from './locales.ts'
import styles from './ModelsSection.module.css'

/**
 * One configured model row. Structurally open, exactly like the Orygin
 ...
 */
export type ModelDraft = OryginModelDraft
 ...
 * {@link formatCapacity}, shared with the Orygin catalog editor so both
