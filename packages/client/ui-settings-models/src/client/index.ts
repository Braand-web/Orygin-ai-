 ...
 * the Models page plus the ordered internal-testing and official-Orygin
 ...
 */
import type { ClientContext } from '@orygin-ai/dsh-client-runtime/client'
import type { ConnectionHandle } from '@orygin-ai/dsh-api-remotes/client'
// Type-only: pulls the shell's SlotMap merge (the 'settings.section' entry).
import type {} from '@orygin-ai/dsh-client-ui-settings/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@orygin-ai/dsh-client-locale/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (settings/credentials invalidations ride the allowlist) into this program.
import type {} from '@orygin-ai/dsh-api-remotes/client'
import { ModelsSection } from './ModelsSection.tsx'
import type { ModelsSectionInjected } from './ModelsSection.tsx'
import { OryginOnboardingDialog } from './OryginOnboardingDialog.tsx'
import type { OryginOnboardingInjected } from './OryginOnboardingDialog.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const oryginOnboardingInjected = (): OryginOnboardingInjected => ({
    controller,
  ...
  ctx.slots.inject('settings.onboarding', () => ctx.slots.register({
    ...
    id: 'orygin-official',
    order: 0,
    inject: oryginOnboardingInjected,
  }, OryginOnboardingDialog))
}
