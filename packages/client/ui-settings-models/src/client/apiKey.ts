 ...
 * @module @orygin-ai/dsh-client-ui-settings-models/apiKey
 */

/**
 * Twin of `normalizeApiKey` in `@orygin-ai/dsh-llm`: printable ASCII, space
 ...
 * `validateOryginModels` is kept in step with the host's `catalogModel`.
 */
