/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-reference`.
 * @module @orygin-ai/dsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-reference'
