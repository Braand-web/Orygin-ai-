# `@orygin-ai/dsh-client-ui-reference`
...
Indirectly, through `@orygin-ai/dsh-file-reference-local` for path guidance and `@orygin-ai/dsh-session-reference` for prepared session snapshots.
