...
import { RpcId } from '@orygin-ai/dsh-client-connection/client'
import type {
...
describe('ChatView', () => {
  ...
  it('hands running calls to a live Tool group', () => {
    ...
    expect(view.getByRole('status').textContent).toBe('Orygin diving...')
  })
  ...
  it('the running clock uses turn/start, ignores steering, and stays out of the live region', () => {
    ...
    expect(status.textContent).toMatch(/^Orygin diving\.\.\.2分0\d秒$/)
