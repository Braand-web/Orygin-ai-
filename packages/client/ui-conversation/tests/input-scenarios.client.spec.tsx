...
import { InputTriggerService } from '@orygin-ai/dsh-client-ui-input-trigger/client'
import type {
  ClientSessionContext, CommandClaim, PickOutcome, SubmitEnvelope, SubmitImageAttachment, SubmitOutcome,
} from '@orygin-ai/dsh-client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@orygin-ai/dsh-client-runtime/client'
