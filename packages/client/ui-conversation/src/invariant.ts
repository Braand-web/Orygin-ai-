/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-conversation`.
 * @module @orygin-ai/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-conversation'
