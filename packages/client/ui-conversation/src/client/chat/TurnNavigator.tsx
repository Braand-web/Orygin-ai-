...
function itemPosition(index: number, count: number): PositionStyle {
...
function railSize(count: number): RailStyle {
  return {
...
/** Compact rail of loaded turns with hover and keyboard previews. */
