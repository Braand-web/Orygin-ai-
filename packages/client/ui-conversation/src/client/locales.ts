...
export const zh = {
  ...
  'placeholder.startConversation': '点击即可开始对话',
  'placeholder.workspace': '选择一个工作区开始',
  'input.commands': '命令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.startConversation': '开始对话',
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.turnNavigation.label': '对话轮次导航',
...
export const en = {
  ...
  'placeholder.startConversation': 'Click to start a conversation',
  'placeholder.workspace': 'Choose a workspace to start',
  'input.commands': 'Commands',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.startConversation': 'Start conversation',
