 ...
 * (Orygin Chat's DragMask). Decoration only: `pointer-events: none` keeps
...
/** Tilted photo-and-note cards (Orygin Chat upload illustration). */
...
/** Greyed cards with a blocked badge (Orygin Chat disabled illustration). */
