/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-attachment`.
 * @module @orygin-ai/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-attachment'
