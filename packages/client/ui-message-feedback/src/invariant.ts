/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-message-feedback`.
 * @module @orygin-ai/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-message-feedback'
