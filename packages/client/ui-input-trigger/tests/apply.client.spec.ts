...
import { createScope, scopeOf, SlotRegistry } from '@orygin-ai/dsh-client-runtime/client'
import type { SessionId } from '@orygin-ai/dsh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@orygin-ai/dsh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@orygin-ai/dsh-client-ui-input-trigger/client'
