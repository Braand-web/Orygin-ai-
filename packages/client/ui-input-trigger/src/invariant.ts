/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-input-trigger`.
 * @module @orygin-ai/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-input-trigger'
