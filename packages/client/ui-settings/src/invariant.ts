/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-settings`.
 * @module @orygin-ai/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-settings'
