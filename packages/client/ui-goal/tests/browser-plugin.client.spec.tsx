...
import { ConversationEventRegistry } from '@orygin-ai/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@orygin-ai/dsh-goal/client'
