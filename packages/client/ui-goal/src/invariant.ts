/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-goal`.
 * @module @orygin-ai/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-goal'
