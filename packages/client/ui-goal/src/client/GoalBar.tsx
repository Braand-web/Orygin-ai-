...
import type { GoalSnapshot } from '@orygin-ai/dsh-goal/client'
import {
...
import type { PropsLocale } from '@orygin-ai/dsh-client-ui-slots'
...
export type GoalDockProps = import('@orygin-ai/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
