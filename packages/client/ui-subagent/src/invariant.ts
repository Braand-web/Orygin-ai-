/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-subagent`.
 * @module @orygin-ai/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-subagent'
