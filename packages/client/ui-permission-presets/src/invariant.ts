/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-permission-presets`.
 * @module @orygin-ai/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-permission-presets'
