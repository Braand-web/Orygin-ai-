/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-slots`.
 * @module @orygin-ai/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-slots'
