/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-plan`.
 * @module @orygin-ai/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-plan'
