...
import type { CommandResult } from '@orygin-ai/dsh-commands/types'
import { createScope, scopeOf } from '@orygin-ai/dsh-client-runtime/client'
import type { SessionId } from '@orygin-ai/dsh-client-runtime/client'
import type { ClientSessionContext, ConsumeTokenRequest, InputTriggerPick, InputTriggerSource, SubmitImageAttachment } from '@orygin-ai/dsh-client-ui-input-trigger/client'
