/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-commands`.
 * @module @orygin-ai/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-commands'
