...
import type { ConvViewProps, ViewTab } from '@orygin-ai/dsh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@orygin-ai/dsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@orygin-ai/dsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@orygin-ai/dsh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@orygin-ai/dsh-client-locale/client'
import { stubSettingsScope } from '@orygin-ai/dsh-client-test-runtime'
import type { LocaleKeysOf } from '@orygin-ai/dsh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@orygin-ai/dsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@orygin-ai/dsh-client-ui-trajectory'
