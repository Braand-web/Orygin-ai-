 ...
 * not built (`pnpm --filter @orygin-ai/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@orygin-ai/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@orygin-ai/dsh-client-runtime/client', await import('@orygin-ai/dsh-client-runtime/client')],
      ['@orygin-ai/dsh-client-ui-primitives', await import('@orygin-ai/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@orygin-ai/dsh-client-locale/client')
