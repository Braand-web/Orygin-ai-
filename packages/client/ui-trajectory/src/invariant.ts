/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-trajectory`.
 * @module @orygin-ai/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-trajectory'
