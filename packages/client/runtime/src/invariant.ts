/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-runtime`.
 * @module @orygin-ai/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@orygin-ai/dsh-client-ui-slots'
import type { InvariantInstaller } from '@orygin-ai/dsh-invariants'

const PACKAGE_NAME = '@orygin-ai/dsh-client-runtime'
