...
import type { SessionId, WorkspaceId } from '@orygin-ai/dsh-api-remotes/client'
...
export interface SessionsPort {
   ...
   * @param opts - optional target workspace; omitted creates a chat-only
   * session at the host's deployment default.
