/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-skill`.
 * @module @orygin-ai/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-skill'
