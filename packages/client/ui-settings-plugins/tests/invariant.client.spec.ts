...
import * as PluginConfigInvariant from '@orygin-ai/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@orygin-ai/dsh-client-ui-settings-plugins')
