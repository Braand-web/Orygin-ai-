/**
 * The web-search card's staged form over the `web-search-orygin` settings
 * namespace.
 *
...
import type { IApiClient } from '@orygin-ai/dsh-client-connection/client'
import type { SettingsScope, SettingsScopeSnapshot, SnapshotStore } from '@orygin-ai/dsh-client-runtime/client'
import {
...
/**
 * Namespace of the Orygin search provider. Spelled here rather than
 * imported: a client package must not depend on a Host package.
 */
export const WEB_SEARCH_NS = 'web-search-orygin'

/** Credential reference the provider resolves when the section names none. */
const DEFAULT_API_KEY_REF = 'ORYGIN_API_KEY'
...
/** Bridges the `web-search-orygin` scope and the credentials domain onto the card. */
export class WebSearchCardController {
  ...
  /**
   * @param scope - the bound settings scope for the `web-search-orygin` namespace.
