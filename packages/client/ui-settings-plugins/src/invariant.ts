/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-settings-plugins`.
 * @module @orygin-ai/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-settings-plugins'
