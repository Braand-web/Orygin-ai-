...
- **A narrow viewport may squeeze the conversation below its preferred floor** — the explicitly open details panel keeps its minimum width instead of disappearing; narrow-screen presentation remains a separate responsive concern.
