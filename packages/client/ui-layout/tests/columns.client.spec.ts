...
} from '@orygin-ai/dsh-client-ui-layout/src/client/columns.ts'
...
describe('computeColumns', () => {
  ...
  it('step 3: details stays open at its minimum while center absorbs the deficit', () => {
    // 280 + 300 + 640 = 1220 > 1210 → details stays at 300 and center becomes 630.
  ...
  it('sidebar-closed narrow window: details concedes but remains open', () => {
  ...
  it('tiny viewport: details remains open and the center may collapse', () => {
  ...
  it('recovery is pure: re-widening restores the preferred details width', () => {
...
describe('computeColumns — degenerate viewports', () => {
  it('sidebar closed and viewport below CENTER_MIN: details remains explicitly open', () => {
