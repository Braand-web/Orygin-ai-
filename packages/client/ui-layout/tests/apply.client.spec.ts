...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@orygin-ai/dsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@orygin-ai/dsh-client-ui-layout/client'
import { apply as nodeApply } from '@orygin-ai/dsh-client-ui-layout'
import * as invariant from '@orygin-ai/dsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@orygin-ai/dsh-client-ui-layout', expect.any(Function))
