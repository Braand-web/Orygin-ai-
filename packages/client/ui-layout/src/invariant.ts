/**
 * Package-owned invariant companion for `@orygin-ai/dsh-client-ui-layout`.
 * @module @orygin-ai/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-client-ui-layout'
