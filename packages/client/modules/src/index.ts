 ...
 * `window.__ORYGIN_BOOT__` entry graph (wire single source: {@link WebBootEntry}
 ...
 * @module @orygin-ai/dsh-client-modules
 */
...
import { Service } from '@orygin-ai/cordis'
import type { Context } from '@orygin-ai/cordis'
import type {} from '@orygin-ai/cordis-plugin-loader'
import type { IndexInjection } from '@orygin-ai/dsh-host-webserver'
...
const CLIENT_MODULES_ID = '@orygin-ai/dsh-client-modules'

/** Dynamic package whose ordinary client bundle must be registered before plugin boot starts. */
const CLIENT_RUNTIME_ID = '@orygin-ai/dsh-client-runtime'
...
window.__ModuleLoader__={
  ...
  return [
    ...
    ...preload,
    { kind: 'global', name: '__ORYGIN_BOOT__', value: graph },
  ]
}
