/**
 * Package-owned invariant companion for `@orygin-ai/dsh-workspace`.
 * @module @orygin-ai/dsh-workspace/invariant
 */
...
import { WorkspaceId } from '@orygin-ai/dsh-workspace'

const PACKAGE_NAME = '@orygin-ai/dsh-workspace'
