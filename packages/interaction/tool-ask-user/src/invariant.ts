/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-ask-user`.
 * @module @orygin-ai/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-ask-user'
