/**
 * Package-owned invariant companion for `@orygin-ai/dsh-user-questions`.
 * @module @orygin-ai/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-user-questions'
