 ...
 * @module @orygin-ai/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@orygin-ai/cordis'
import { AttachmentError, AttachmentId } from '@orygin-ai/dsh-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@orygin-ai/dsh-attachment'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { GenericCallView, ToolExecution } from '@orygin-ai/dsh-tools'
import type {} from '@orygin-ai/dsh-fs'
