 ...
 * @module @orygin-ai/dsh-tool-fs/src/write
 */

import type { Context } from '@orygin-ai/cordis'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@orygin-ai/dsh-tools'
import type { FsWriteOutcome } from '@orygin-ai/dsh-fs'
