/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-str-replace-editor`.
 * @module @orygin-ai/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-str-replace-editor'
