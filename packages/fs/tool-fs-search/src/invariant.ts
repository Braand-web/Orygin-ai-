/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-fs-search`.
 * @module @orygin-ai/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-fs-search'
