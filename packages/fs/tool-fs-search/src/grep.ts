 ...
 *
 * @module @orygin-ai/dsh-tool-fs-search/grep
 */

import type { Context } from '@orygin-ai/cordis'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@orygin-ai/dsh-tools'
import type { RetainedItems } from '@orygin-ai/dsh-output-retention'
import type { SpillRef } from '@orygin-ai/dsh-spill'
