 ...
 *
 * @module @orygin-ai/dsh-tool-fs-search/search-core
 */
...
import { ItemRetainer, TextRetainer } from '@orygin-ai/dsh-output-retention'
import type { RetainedItems } from '@orygin-ai/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@orygin-ai/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@orygin-ai/dsh-spill'
 ...
 * `@orygin-ai/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@orygin-ai/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@orygin-ai/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@orygin-ai/dsh-tool-fs-search/presentation} `grepSearchMeta`)
