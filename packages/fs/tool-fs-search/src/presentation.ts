 ...
 * model-facing render consumes ({@link module:@orygin-ai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @orygin-ai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@orygin-ai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
