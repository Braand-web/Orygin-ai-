/**
 * Package-owned invariant companion for `@orygin-ai/dsh-sdk-jsonrpc-server`.
 * @module @orygin-ai/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-sdk-jsonrpc-server'
