 ...
 *
 * @module @orygin-ai/dsh-sdk-client/types
 */
...
export interface HarnessClientOptions {
   ...
   * credential policy (see `scrubbedParentEnv` in `@orygin-ai/dsh-subprocess`
...
/** Options for the high-level {@link OryginHarness} wrapper. */
export interface OryginHarnessOptions {
  ...
  cwd?: string
  /** Provider route for SDK-created agents (default `orygin-official`). */
  provider?: string
  /** Model for SDK-created agents (default `orygin-v4-flash`). */
  model?: string
