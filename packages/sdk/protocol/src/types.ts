/**
 * Named wire types for the Orygin SDK runtime protocol: the three
 * request/result pairs and the four server-to-client notification payloads
 * exchanged over the newline-delimited JSON-RPC stdio transport. The server
 * plugin (`@orygin-ai/dsh-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `orygin-ai-sdk-runtime`.
 *
 * @module @orygin-ai/dsh-sdk-protocol/types
 */

import type { ContentBlock } from '@orygin-ai/dsh-llm'
import type { SessionEvent } from '@orygin-ai/dsh-session'
import type { SubagentStopReason } from '@orygin-ai/dsh-subagent'
...
export interface InitializeResult {
  /** Wire-stable server identity (`orygin-ai-sdk-runtime`) and version. */
