/**
 * Package-owned invariant companion for `@orygin-ai/dsh-sdk-protocol`.
 * @module @orygin-ai/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-sdk-protocol'
