/**
 * Unit + real-load-path coverage for @orygin-ai/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@orygin-ai/dsh-llm'
import SystemPrompt from '@orygin-ai/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@orygin-ai/dsh-tools'
import * as timeoutPolicy from '@orygin-ai/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@orygin-ai/dsh-tool-call-timeout-policy'
