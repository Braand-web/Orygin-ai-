/**
 * Package-owned invariant companion for `@orygin-ai/dsh-tool-call-timeout-policy`.
 * @module @orygin-ai/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-tool-call-timeout-policy'
