/**
 * Package-owned invariant companion for `@orygin-ai/dsh-repeat-tool-reminder`.
 * @module @orygin-ai/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-repeat-tool-reminder'
