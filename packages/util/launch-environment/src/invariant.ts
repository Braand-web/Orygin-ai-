/**
 * Package-owned invariant companion for `@orygin-ai/dsh-launch-environment`.
 * @module @orygin-ai/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-launch-environment'
