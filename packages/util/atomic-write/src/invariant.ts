/**
 * Package-owned invariant companion for `@orygin-ai/dsh-atomic-write`.
 * @module @orygin-ai/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-atomic-write'
