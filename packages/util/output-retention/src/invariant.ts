/**
 * Package-owned invariant companion for `@orygin-ai/dsh-output-retention`.
 * @module @orygin-ai/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-output-retention'
