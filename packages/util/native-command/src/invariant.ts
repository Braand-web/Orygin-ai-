/**
 * Package-owned invariant companion for `@orygin-ai/dsh-native-command`.
 * @module @orygin-ai/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-native-command'
