/** Package-owned session-event invariants for sandbox policy. @module @orygin-ai/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@orygin-ai/dsh-sandbox-policy'
