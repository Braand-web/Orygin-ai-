/**
 * Package-owned invariant companion for `@orygin-ai/dsh-sandbox-windows-acl`.
 * @module @orygin-ai/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-sandbox-windows-acl'
