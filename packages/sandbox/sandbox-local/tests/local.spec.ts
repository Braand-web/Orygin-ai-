...
import type { SandboxPolicy } from '@orygin-ai/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@orygin-ai/dsh-sandbox-local'
import type { Config } from '@orygin-ai/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @orygin-ai/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
