 ...
 *
 * @module @orygin-ai/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@orygin-ai/node-addon-landlock-run'
 ...
 * (`@orygin-ai/dsh-fs-sandbox`) can never drift apart.
