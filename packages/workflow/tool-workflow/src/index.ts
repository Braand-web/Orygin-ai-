 ...
 * (`@orygin-ai/dsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @orygin-ai/dsh-tool-workflow
 */

import type { Context } from '@orygin-ai/cordis'
import z from '@orygin-ai/schemastery'
import { defineTool } from '@orygin-ai/dsh-tools'
import type { ToolCallView, ToolResultView } from '@orygin-ai/dsh-tools'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@orygin-ai/dsh-session'
import type {
