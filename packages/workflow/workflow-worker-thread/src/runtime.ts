 ...
 * @module @orygin-ai/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@orygin-ai/dsh-llm'
import { SessionId } from '@orygin-ai/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@orygin-ai/dsh-tools'
import type { ObjectJsonSchema } from '@orygin-ai/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@orygin-ai/dsh-workflow'
import type {
