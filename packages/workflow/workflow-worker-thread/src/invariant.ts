/**
 * Package-owned invariant companion for `@orygin-ai/dsh-workflow-worker-thread`.
 * @module @orygin-ai/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@orygin-ai/dsh-workflow-worker-thread'
