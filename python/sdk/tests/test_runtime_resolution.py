...
import orygin_harness_runtime as runtime
import pytest

from orygin_harness_runtime import (
...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@orygin-ai/dsh-agent-spine-demo" in config
    assert "@orygin-ai/dsh-session-persistence-jsonl" in config
    assert "@orygin-ai/dsh-session-checkpoint-policy" in config
