...
Python packages for driving Orygin as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.

## Packages

| Directory | Dist / module | Role |
|---|---|---|
| [sdk](sdk/README.md) | `orygin-ai-sdk` / `orygin_harness` | High-level turns API and lower-level JSON-RPC client |
| [sdk-runtime](sdk-runtime/README.md) | `orygin-ai-runtime-bin` / `orygin_harness_runtime` | Bundled runtime binaries and default agent configuration |
